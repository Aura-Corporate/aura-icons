...
class AuraIconsLineDuotone {
  ...
  static const AuraIconData airbudsCharge = AuraIconData('assets/vectors/line_duotone/airbuds-charge.vec', accentAssetPath: 'assets/vectors/line_duotone/airbuds-charge-accent.vec');
  static const AuraIconData airbudsCheck = AuraIconData('assets/vectors/line_duotone/airbuds-check.vec', accentAssetPath: 'assets/vectors/line_duotone/airbuds-check-accent.vec');
  static const AuraIconData airbudsLeft = AuraIconData('assets/vectors/line_duotone/airbuds-left.vec', accentAssetPath: 'assets/vectors/line_duotone/airbuds-left-accent.vec');
  static const AuraIconData airbudsRemove = AuraIconData('assets/vectors/line_duotone/airbuds-remove.vec', accentAssetPath: 'assets/vectors/line_duotone/airbuds-remove-accent.vec');
  static const AuraIconData airbudsRight = AuraIconData('assets/vectors/line_duotone/airbuds-right.vec', accentAssetPath: 'assets/vectors/line_duotone/airbuds-right-accent.vec');
  static const AuraIconData alarm = AuraIconData('assets/vectors/line_duotone/alarm.vec', accentAssetPath: 'assets/vectors/line_duotone/alarm-accent.vec', accentBehindMain: true);
  static const AuraIconData alarmAdd = AuraIconData('assets/vectors/line_duotone/alarm-add.vec', accentAssetPath: 'assets/vectors/line_duotone/alarm-add-accent.vec', accentBehindMain: true);
  static const AuraIconData alarmPause = AuraIconData('assets/vectors/line_duotone/alarm-pause.vec', accentAssetPath: 'assets/vectors/line_duotone/alarm-pause-accent.vec', accentBehindMain: true);
  static const AuraIconData alarmPlay = AuraIconData('assets/vectors/line_duotone/alarm-play.vec', accentAssetPath: 'assets/vectors/line_duotone/alarm-play-accent.vec', accentBehindMain: true);
  static const AuraIconData alarmRemove = AuraIconData('assets/vectors/line_duotone/alarm-remove.vec', accentAssetPath: 'assets/vectors/line_duotone/alarm-remove-accent.vec', accentBehindMain: true);
  static const AuraIconData alarmSleep = AuraIconData('assets/vectors/line_duotone/alarm-sleep.vec', accentAssetPath: 'assets/vectors/line_duotone/alarm-sleep-accent.vec', accentBehindMain: true);
  static const AuraIconData alarmTurnOff = AuraIconData('assets/vectors/line_duotone/alarm-turn-off.vec', accentAssetPath: 'assets/vectors/line_duotone/alarm-turn-off-accent.vec', accentBehindMain: true);
  static const AuraIconData album = AuraIconData('assets/vectors/line_duotone/album.vec', accentAssetPath: 'assets/vectors/line_duotone/album-accent.vec');
  static const AuraIconData alignBottom = AuraIconData('assets/vectors/line_duotone/align-bottom.vec', accentAssetPath: 'assets/vectors/line_duotone/align-bottom-accent.vec', accentBehindMain: true);
  static const AuraIconData alignHorizontalCenter = AuraIconData('assets/vectors/line_duotone/align-horizontal-center.vec', accentAssetPath: 'assets/vectors/line_duotone/align-horizontal-center-accent.vec', accentBehindMain: true);
  static const AuraIconData alignHorizontalSpacing = AuraIconData('assets/vectors/line_duotone/align-horizontal-spacing.vec', accentAssetPath: 'assets/vectors/line_duotone/align-horizontal-spacing-accent.vec', accentBehindMain: true);
  static const AuraIconData alignLeft = AuraIconData('assets/vectors/line_duotone/align-left.vec', accentAssetPath: 'assets/vectors/line_duotone/align-left-accent.vec', accentBehindMain: true);
  static const AuraIconData alignRight = AuraIconData('assets/vectors/line_duotone/align-right.vec', accentAssetPath: 'assets/vectors/line_duotone/align-right-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData backpack = AuraIconData('assets/vectors/line_duotone/backpack.vec', accentAssetPath: 'assets/vectors/line_duotone/backpack-accent.vec');
  static const AuraIconData backspace = AuraIconData('assets/vectors/line_duotone/backspace.vec', accentAssetPath: 'assets/vectors/line_duotone/backspace-accent.vec', accentBehindMain: true);
  static const AuraIconData bacteria = AuraIconData('assets/vectors/line_duotone/bacteria.vec', accentAssetPath: 'assets/vectors/line_duotone/bacteria-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData batteryChargeMinimalistic = AuraIconData('assets/vectors/line_duotone/battery-charge-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/battery-charge-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData batteryFull = AuraIconData('assets/vectors/line_duotone/battery-full.vec', accentAssetPath: 'assets/vectors/line_duotone/battery-full-accent.vec');
  static const AuraIconData batteryFullMinimalistic = AuraIconData('assets/vectors/line_duotone/battery-full-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/battery-full-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData batteryHalf = AuraIconData('assets/vectors/line_duotone/battery-half.vec', accentAssetPath: 'assets/vectors/line_duotone/battery-half-accent.vec');
  static const AuraIconData batteryHalfMinimalistic = AuraIconData('assets/vectors/line_duotone/battery-half-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/battery-half-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData batteryLow = AuraIconData('assets/vectors/line_duotone/battery-low.vec', accentAssetPath: 'assets/vectors/line_duotone/battery-low-accent.vec');
  static const AuraIconData batteryLowMinimalistic = AuraIconData('assets/vectors/line_duotone/battery-low-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/battery-low-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData bed = AuraIconData('assets/vectors/line_duotone/bed.vec', accentAssetPath: 'assets/vectors/line_duotone/bed-accent.vec', accentBehindMain: true);
  static const AuraIconData bedsideTable = AuraIconData('assets/vectors/line_duotone/bedside-table.vec', accentAssetPath: 'assets/vectors/line_duotone/bedside-table-accent.vec', accentBehindMain: true);
  static const AuraIconData bedsideTable2 = AuraIconData('assets/vectors/line_duotone/bedside-table-2.vec', accentAssetPath: 'assets/vectors/line_duotone/bedside-table-2-accent.vec', accentBehindMain: true);
  static const AuraIconData bedsideTable3 = AuraIconData('assets/vectors/line_duotone/bedside-table-3.vec', accentAssetPath: 'assets/vectors/line_duotone/bedside-table-3-accent.vec', accentBehindMain: true);
  static const AuraIconData bedsideTable4 = AuraIconData('assets/vectors/line_duotone/bedside-table-4.vec', accentAssetPath: 'assets/vectors/line_duotone/bedside-table-4-accent.vec', accentBehindMain: true);
  static const AuraIconData bell = AuraIconData('assets/vectors/line_duotone/bell.vec', accentAssetPath: 'assets/vectors/line_duotone/bell-accent.vec');
  static const AuraIconData bellOff = AuraIconData('assets/vectors/line_duotone/bell-off.vec', accentAssetPath: 'assets/vectors/line_duotone/bell-off-accent.vec');
  static const AuraIconData bellRing = AuraIconData('assets/vectors/line_duotone/bell-ring.vec', accentAssetPath: 'assets/vectors/line_duotone/bell-ring-accent.vec');
  static const AuraIconData benzeneRing = AuraIconData('assets/vectors/line_duotone/benzene-ring.vec', accentAssetPath: 'assets/vectors/line_duotone/benzene-ring-accent.vec');
  static const AuraIconData bicycling = AuraIconData('assets/vectors/line_duotone/bicycling.vec', accentAssetPath: 'assets/vectors/line_duotone/bicycling-accent.vec');
  static const AuraIconData bicyclingRound = AuraIconData('assets/vectors/line_duotone/bicycling-round.vec', accentAssetPath: 'assets/vectors/line_duotone/bicycling-round-accent.vec');
  static const AuraIconData bill = AuraIconData('assets/vectors/line_duotone/bill.vec', accentAssetPath: 'assets/vectors/line_duotone/bill-accent.vec', accentBehindMain: true);
  static const AuraIconData bill2 = AuraIconData('assets/vectors/line_duotone/bill-2.vec', accentAssetPath: 'assets/vectors/line_duotone/bill-2-accent.vec');
  ...
  static const AuraIconData boltCircle = AuraIconData('assets/vectors/line_duotone/bolt-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/bolt-circle-accent.vec');
  ...
  static const AuraIconData buildings3 = AuraIconData('assets/vectors/line_duotone/buildings-3.vec', accentAssetPath: 'assets/vectors/line_duotone/buildings-3-accent.vec');
  static const AuraIconData bus = AuraIconData('assets/vectors/line_duotone/bus.vec', accentAssetPath: 'assets/vectors/line_duotone/bus-accent.vec');
  static const AuraIconData calculator = AuraIconData('assets/vectors/line_duotone/calculator.vec', accentAssetPath: 'assets/vectors/line_duotone/calculator-accent.vec');
  static const AuraIconData calculatorMinimalistic = AuraIconData('assets/vectors/line_duotone/calculator-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/calculator-minimalistic-accent.vec');
  static const AuraIconData calendar = AuraIconData('assets/vectors/line_duotone/calendar.vec', accentAssetPath: 'assets/vectors/line_duotone/calendar-accent.vec');
  static const AuraIconData calendarAdd = AuraIconData('assets/vectors/line_duotone/calendar-add.vec', accentAssetPath: 'assets/vectors/line_duotone/calendar-add-accent.vec');
  static const AuraIconData calendarDate = AuraIconData('assets/vectors/line_duotone/calendar-date.vec', accentAssetPath: 'assets/vectors/line_duotone/calendar-date-accent.vec');
  static const AuraIconData calendarMark = AuraIconData('assets/vectors/line_duotone/calendar-mark.vec', accentAssetPath: 'assets/vectors/line_duotone/calendar-mark-accent.vec');
  ...
  static const AuraIconData callDroppedRounded = AuraIconData('assets/vectors/line_duotone/call-dropped-rounded.vec', accentAssetPath: 'assets/vectors/line_duotone/call-dropped-rounded-accent.vec');
  static const AuraIconData callMedicine = AuraIconData('assets/vectors/line_duotone/call-medicine.vec', accentAssetPath: 'assets/vectors/line_duotone/call-medicine-accent.vec');
  static const AuraIconData callMedicineRounded = AuraIconData('assets/vectors/line_duotone/call-medicine-rounded.vec', accentAssetPath: 'assets/vectors/line_duotone/call-medicine-rounded-accent.vec');
  ...
  static const AuraIconData cardReceive = AuraIconData('assets/vectors/line_duotone/card-receive.vec', accentAssetPath: 'assets/vectors/line_duotone/card-receive-accent.vec');
  static const AuraIconData cardSearch = AuraIconData('assets/vectors/line_duotone/card-search.vec', accentAssetPath: 'assets/vectors/line_duotone/card-search-accent.vec');
  ...
  static const AuraIconData cartCross = AuraIconData('assets/vectors/line_duotone/cart-cross.vec', accentAssetPath: 'assets/vectors/line_duotone/cart-cross-accent.vec', accentBehindMain: true);
  static const AuraIconData cartLarge = AuraIconData('assets/vectors/line_duotone/cart-large.vec', accentAssetPath: 'assets/vectors/line_duotone/cart-large-accent.vec');
  static const AuraIconData cartLarge2 = AuraIconData('assets/vectors/line_duotone/cart-large-2.vec', accentAssetPath: 'assets/vectors/line_duotone/cart-large-2-accent.vec');
  static const AuraIconData cartLarge3 = AuraIconData('assets/vectors/line_duotone/cart-large-3.vec', accentAssetPath: 'assets/vectors/line_duotone/cart-large-3-accent.vec', accentBehindMain: true);
  static const AuraIconData cartLarge4 = AuraIconData('assets/vectors/line_duotone/cart-large-4.vec', accentAssetPath: 'assets/vectors/line_duotone/cart-large-4-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData cat = AuraIconData('assets/vectors/line_duotone/cat.vec', accentAssetPath: 'assets/vectors/line_duotone/cat-accent.vec');
  static const AuraIconData chair = AuraIconData('assets/vectors/line_duotone/chair.vec', accentAssetPath: 'assets/vectors/line_duotone/chair-accent.vec', accentBehindMain: true);
  static const AuraIconData chair2 = AuraIconData('assets/vectors/line_duotone/chair-2.vec', accentAssetPath: 'assets/vectors/line_duotone/chair-2-accent.vec');
  static const AuraIconData chandelier = AuraIconData('assets/vectors/line_duotone/chandelier.vec', accentAssetPath: 'assets/vectors/line_duotone/chandelier-accent.vec');
  ...
  static const AuraIconData checklist = AuraIconData('assets/vectors/line_duotone/checklist.vec', accentAssetPath: 'assets/vectors/line_duotone/checklist-accent.vec');
  static const AuraIconData checklistMinimalistic = AuraIconData('assets/vectors/line_duotone/checklist-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/checklist-minimalistic-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData clapperboard = AuraIconData('assets/vectors/line_duotone/clapperboard.vec', accentAssetPath: 'assets/vectors/line_duotone/clapperboard-accent.vec');
  static const AuraIconData clapperboardEdit = AuraIconData('assets/vectors/line_duotone/clapperboard-edit.vec', accentAssetPath: 'assets/vectors/line_duotone/clapperboard-edit-accent.vec');
  static const AuraIconData clapperboardOpen = AuraIconData('assets/vectors/line_duotone/clapperboard-open.vec', accentAssetPath: 'assets/vectors/line_duotone/clapperboard-open-accent.vec');
  static const AuraIconData clapperboardOpenPlay = AuraIconData('assets/vectors/line_duotone/clapperboard-open-play.vec', accentAssetPath: 'assets/vectors/line_duotone/clapperboard-open-play-accent.vec');
  static const AuraIconData clapperboardPlay = AuraIconData('assets/vectors/line_duotone/clapperboard-play.vec', accentAssetPath: 'assets/vectors/line_duotone/clapperboard-play-accent.vec');
  static const AuraIconData clapperboardText = AuraIconData('assets/vectors/line_duotone/clapperboard-text.vec', accentAssetPath: 'assets/vectors/line_duotone/clapperboard-text-accent.vec');
  ...
  static const AuraIconData closet2 = AuraIconData('assets/vectors/line_duotone/closet-2.vec', accentAssetPath: 'assets/vectors/line_duotone/closet-2-accent.vec', accentBehindMain: true);
  static const AuraIconData cloud = AuraIconData('assets/vectors/line_duotone/cloud.vec', accentAssetPath: 'assets/vectors/line_duotone/cloud-accent.vec');
  static const AuraIconData cloudBolt = AuraIconData('assets/vectors/line_duotone/cloud-bolt.vec', accentAssetPath: 'assets/vectors/line_duotone/cloud-bolt-accent.vec', accentBehindMain: true);
  static const AuraIconData cloudBoltMinimalistic = AuraIconData('assets/vectors/line_duotone/cloud-bolt-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/cloud-bolt-minimalistic-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData cloudSnowfall = AuraIconData('assets/vectors/line_duotone/cloud-snowfall.vec', accentAssetPath: 'assets/vectors/line_duotone/cloud-snowfall-accent.vec', accentBehindMain: true);
  static const AuraIconData cloudSnowfallMinimalistic = AuraIconData('assets/vectors/line_duotone/cloud-snowfall-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/cloud-snowfall-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData cloudStorage = AuraIconData('assets/vectors/line_duotone/cloud-storage.vec', accentAssetPath: 'assets/vectors/line_duotone/cloud-storage-accent.vec');
  static const AuraIconData cloudStorm = AuraIconData('assets/vectors/line_duotone/cloud-storm.vec', accentAssetPath: 'assets/vectors/line_duotone/cloud-storm-accent.vec', accentBehindMain: true);
  static const AuraIconData cloudSun = AuraIconData('assets/vectors/line_duotone/cloud-sun.vec', accentAssetPath: 'assets/vectors/line_duotone/cloud-sun-accent.vec');
  static const AuraIconData cloudSun2 = AuraIconData('assets/vectors/line_duotone/cloud-sun-2.vec', accentAssetPath: 'assets/vectors/line_duotone/cloud-sun-2-accent.vec');
  static const AuraIconData cloudUpload = AuraIconData('assets/vectors/line_duotone/cloud-upload.vec', accentAssetPath: 'assets/vectors/line_duotone/cloud-upload-accent.vec', accentBehindMain: true);
  static const AuraIconData cloudWaterdrop = AuraIconData('assets/vectors/line_duotone/cloud-waterdrop.vec', accentAssetPath: 'assets/vectors/line_duotone/cloud-waterdrop-accent.vec', accentBehindMain: true);
  static const AuraIconData cloudWaterdrops = AuraIconData('assets/vectors/line_duotone/cloud-waterdrops.vec', accentAssetPath: 'assets/vectors/line_duotone/cloud-waterdrops-accent.vec', accentBehindMain: true);
  static const AuraIconData clouds = AuraIconData('assets/vectors/line_duotone/clouds.vec', accentAssetPath: 'assets/vectors/line_duotone/clouds-accent.vec', accentBehindMain: true);
  static const AuraIconData cloudyMoon = AuraIconData('assets/vectors/line_duotone/cloudy-moon.vec', accentAssetPath: 'assets/vectors/line_duotone/cloudy-moon-accent.vec');
  ...
  static const AuraIconData compassSquare = AuraIconData('assets/vectors/line_duotone/compass-square.vec', accentAssetPath: 'assets/vectors/line_duotone/compass-square-accent.vec');
  static const AuraIconData conditioner = AuraIconData('assets/vectors/line_duotone/conditioner.vec', accentAssetPath: 'assets/vectors/line_duotone/conditioner-accent.vec');
  static const AuraIconData conditioner2 = AuraIconData('assets/vectors/line_duotone/conditioner-2.vec', accentAssetPath: 'assets/vectors/line_duotone/conditioner-2-accent.vec');
  static const AuraIconData confetti = AuraIconData('assets/vectors/line_duotone/confetti.vec', accentAssetPath: 'assets/vectors/line_duotone/confetti-accent.vec');
  ...
  static const AuraIconData courseDown = AuraIconData('assets/vectors/line_duotone/course-down.vec', accentAssetPath: 'assets/vectors/line_duotone/course-down-accent.vec', accentBehindMain: true);
  static const AuraIconData courseUp = AuraIconData('assets/vectors/line_duotone/course-up.vec', accentAssetPath: 'assets/vectors/line_duotone/course-up-accent.vec', accentBehindMain: true);
  static const AuraIconData cpu = AuraIconData('assets/vectors/line_duotone/cpu.vec', accentAssetPath: 'assets/vectors/line_duotone/cpu-accent.vec', accentBehindMain: true);
  static const AuraIconData cpuBolt = AuraIconData('assets/vectors/line_duotone/cpu-bolt.vec', accentAssetPath: 'assets/vectors/line_duotone/cpu-bolt-accent.vec', accentBehindMain: true);
  static const AuraIconData creativeCommons = AuraIconData('assets/vectors/line_duotone/creative-commons.vec', accentAssetPath: 'assets/vectors/line_duotone/creative-commons-accent.vec', accentBehindMain: true);
  static const AuraIconData crop = AuraIconData('assets/vectors/line_duotone/crop.vec', accentAssetPath: 'assets/vectors/line_duotone/crop-accent.vec');
  ...
  static const AuraIconData dangerCircle = AuraIconData('assets/vectors/line_duotone/danger-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/danger-circle-accent.vec', accentBehindMain: true);
  static const AuraIconData dangerSquare = AuraIconData('assets/vectors/line_duotone/danger-square.vec', accentAssetPath: 'assets/vectors/line_duotone/danger-square-accent.vec');
  static const AuraIconData dangerTriangle = AuraIconData('assets/vectors/line_duotone/danger-triangle.vec', accentAssetPath: 'assets/vectors/line_duotone/danger-triangle-accent.vec', accentBehindMain: true);
  static const AuraIconData database = AuraIconData('assets/vectors/line_duotone/database.vec', accentAssetPath: 'assets/vectors/line_duotone/database-accent.vec');
  static const AuraIconData delivery = AuraIconData('assets/vectors/line_duotone/delivery.vec', accentAssetPath: 'assets/vectors/line_duotone/delivery-accent.vec');
  static const AuraIconData devices = AuraIconData('assets/vectors/line_duotone/devices.vec', accentAssetPath: 'assets/vectors/line_duotone/devices-accent.vec');
  static const AuraIconData diagramDown = AuraIconData('assets/vectors/line_duotone/diagram-down.vec', accentAssetPath: 'assets/vectors/line_duotone/diagram-down-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData display = AuraIconData('assets/vectors/line_duotone/display.vec', accentAssetPath: 'assets/vectors/line_duotone/display-accent.vec');
  static const AuraIconData dna = AuraIconData('assets/vectors/line_duotone/dna.vec', accentAssetPath: 'assets/vectors/line_duotone/dna-accent.vec');
  static const AuraIconData document = AuraIconData('assets/vectors/line_duotone/document.vec', accentAssetPath: 'assets/vectors/line_duotone/document-accent.vec', accentBehindMain: true);
  static const AuraIconData document2 = AuraIconData('assets/vectors/line_duotone/document-2.vec', accentAssetPath: 'assets/vectors/line_duotone/document-2-accent.vec');
  ...
  static const AuraIconData doubleAltArrowUp = AuraIconData('assets/vectors/line_duotone/double-alt-arrow-up.vec', accentAssetPath: 'assets/vectors/line_duotone/double-alt-arrow-up-accent.vec');
  static const AuraIconData download = AuraIconData('assets/vectors/line_duotone/download.vec', accentAssetPath: 'assets/vectors/line_duotone/download-accent.vec', accentBehindMain: true);
  static const AuraIconData downloadMinimalistic = AuraIconData('assets/vectors/line_duotone/download-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/download-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData downloadSquare = AuraIconData('assets/vectors/line_duotone/download-square.vec', accentAssetPath: 'assets/vectors/line_duotone/download-square-accent.vec');
  static const AuraIconData downloadTwiceSquare = AuraIconData('assets/vectors/line_duotone/download-twice-square.vec', accentAssetPath: 'assets/vectors/line_duotone/download-twice-square-accent.vec');
  static const AuraIconData dropper = AuraIconData('assets/vectors/line_duotone/dropper.vec', accentAssetPath: 'assets/vectors/line_duotone/dropper-accent.vec');
  static const AuraIconData dropper2 = AuraIconData('assets/vectors/line_duotone/dropper-2.vec', accentAssetPath: 'assets/vectors/line_duotone/dropper-2-accent.vec');
  ...
  static const AuraIconData dumbbells = AuraIconData('assets/vectors/line_duotone/dumbbells.vec', accentAssetPath: 'assets/vectors/line_duotone/dumbbells-accent.vec');
  static const AuraIconData dumbbells2 = AuraIconData('assets/vectors/line_duotone/dumbbells-2.vec', accentAssetPath: 'assets/vectors/line_duotone/dumbbells-2-accent.vec', accentBehindMain: true);
  static const AuraIconData earth = AuraIconData('assets/vectors/line_duotone/earth.vec', accentAssetPath: 'assets/vectors/line_duotone/earth-accent.vec');
  ...
  static const AuraIconData expressionlessCircle = AuraIconData('assets/vectors/line_duotone/expressionless-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/expressionless-circle-accent.vec', accentBehindMain: true);
  static const AuraIconData expressionlessSquare = AuraIconData('assets/vectors/line_duotone/expressionless-square.vec', accentAssetPath: 'assets/vectors/line_duotone/expressionless-square-accent.vec');
  static const AuraIconData eye = AuraIconData('assets/vectors/line_duotone/eye.vec', accentAssetPath: 'assets/vectors/line_duotone/eye-accent.vec', accentBehindMain: true);
  static const AuraIconData eyeClosed = AuraIconData('assets/vectors/line_duotone/eye-closed.vec', accentAssetPath: 'assets/vectors/line_duotone/eye-closed-accent.vec');
  static const AuraIconData eyeScan = AuraIconData('assets/vectors/line_duotone/eye-scan.vec', accentAssetPath: 'assets/vectors/line_duotone/eye-scan-accent.vec', accentBehindMain: true);
  static const AuraIconData faceScanCircle = AuraIconData('assets/vectors/line_duotone/face-scan-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/face-scan-circle-accent.vec');
  static const AuraIconData faceScanSquare = AuraIconData('assets/vectors/line_duotone/face-scan-square.vec', accentAssetPath: 'assets/vectors/line_duotone/face-scan-square-accent.vec');
  static const AuraIconData facemaskCircle = AuraIconData('assets/vectors/line_duotone/facemask-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/facemask-circle-accent.vec', accentBehindMain: true);
  static const AuraIconData facemaskSquare = AuraIconData('assets/vectors/line_duotone/facemask-square.vec', accentAssetPath: 'assets/vectors/line_duotone/facemask-square-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData flipHorizontal = AuraIconData('assets/vectors/line_duotone/flip-horizontal.vec', accentAssetPath: 'assets/vectors/line_duotone/flip-horizontal-accent.vec');
  static const AuraIconData flipVertical = AuraIconData('assets/vectors/line_duotone/flip-vertical.vec', accentAssetPath: 'assets/vectors/line_duotone/flip-vertical-accent.vec');
  static const AuraIconData floorLamp = AuraIconData('assets/vectors/line_duotone/floor-lamp.vec', accentAssetPath: 'assets/vectors/line_duotone/floor-lamp-accent.vec');
  static const AuraIconData floorLampMinimalistic = AuraIconData('assets/vectors/line_duotone/floor-lamp-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/floor-lamp-minimalistic-accent.vec');
  static const AuraIconData fog = AuraIconData('assets/vectors/line_duotone/fog.vec', accentAssetPath: 'assets/vectors/line_duotone/fog-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData fullScreenCircle = AuraIconData('assets/vectors/line_duotone/full-screen-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/full-screen-circle-accent.vec');
  static const AuraIconData fullScreenSquare = AuraIconData('assets/vectors/line_duotone/full-screen-square.vec', accentAssetPath: 'assets/vectors/line_duotone/full-screen-square-accent.vec');
  static const AuraIconData gallery = AuraIconData('assets/vectors/line_duotone/gallery.vec', accentAssetPath: 'assets/vectors/line_duotone/gallery-accent.vec');
  static const AuraIconData galleryAdd = AuraIconData('assets/vectors/line_duotone/gallery-add.vec', accentAssetPath: 'assets/vectors/line_duotone/gallery-add-accent.vec');
  static const AuraIconData galleryCheck = AuraIconData('assets/vectors/line_duotone/gallery-check.vec', accentAssetPath: 'assets/vectors/line_duotone/gallery-check-accent.vec');
  static const AuraIconData galleryCircle = AuraIconData('assets/vectors/line_duotone/gallery-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/gallery-circle-accent.vec', accentBehindMain: true);
  static const AuraIconData galleryDownload = AuraIconData('assets/vectors/line_duotone/gallery-download.vec', accentAssetPath: 'assets/vectors/line_duotone/gallery-download-accent.vec');
  static const AuraIconData galleryEdit = AuraIconData('assets/vectors/line_duotone/gallery-edit.vec', accentAssetPath: 'assets/vectors/line_duotone/gallery-edit-accent.vec');
  static const AuraIconData galleryFavorite = AuraIconData('assets/vectors/line_duotone/gallery-favorite.vec', accentAssetPath: 'assets/vectors/line_duotone/gallery-favorite-accent.vec');
  static const AuraIconData galleryMinimalistic = AuraIconData('assets/vectors/line_duotone/gallery-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/gallery-minimalistic-accent.vec');
  ...
  static const AuraIconData gamepadMinimalistic = AuraIconData('assets/vectors/line_duotone/gamepad-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/gamepad-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData gamepadNoCharge = AuraIconData('assets/vectors/line_duotone/gamepad-no-charge.vec', accentAssetPath: 'assets/vectors/line_duotone/gamepad-no-charge-accent.vec');
  static const AuraIconData gamepadOld = AuraIconData('assets/vectors/line_duotone/gamepad-old.vec', accentAssetPath: 'assets/vectors/line_duotone/gamepad-old-accent.vec');
  static const AuraIconData garage = AuraIconData('assets/vectors/line_duotone/garage.vec', accentAssetPath: 'assets/vectors/line_duotone/garage-accent.vec');
  static const AuraIconData gasStation = AuraIconData('assets/vectors/line_duotone/gas-station.vec', accentAssetPath: 'assets/vectors/line_duotone/gas-station-accent.vec');
  ...
  static const AuraIconData golf = AuraIconData('assets/vectors/line_duotone/golf.vec', accentAssetPath: 'assets/vectors/line_duotone/golf-accent.vec', accentBehindMain: true);
  static const AuraIconData gps = AuraIconData('assets/vectors/line_duotone/gps.vec', accentAssetPath: 'assets/vectors/line_duotone/gps-accent.vec');
  static const AuraIconData graph = AuraIconData('assets/vectors/line_duotone/graph.vec', accentAssetPath: 'assets/vectors/line_duotone/graph-accent.vec', accentBehindMain: true);
  static const AuraIconData graphDown = AuraIconData('assets/vectors/line_duotone/graph-down.vec', accentAssetPath: 'assets/vectors/line_duotone/graph-down-accent.vec', accentBehindMain: true);
  static const AuraIconData graphDownNew = AuraIconData('assets/vectors/line_duotone/graph-down-new.vec', accentAssetPath: 'assets/vectors/line_duotone/graph-down-new-accent.vec');
  ...
  static const AuraIconData hashtagCircle = AuraIconData('assets/vectors/line_duotone/hashtag-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/hashtag-circle-accent.vec');
  static const AuraIconData hashtagSquare = AuraIconData('assets/vectors/line_duotone/hashtag-square.vec', accentAssetPath: 'assets/vectors/line_duotone/hashtag-square-accent.vec');
  static const AuraIconData headphonesRound = AuraIconData('assets/vectors/line_duotone/headphones-round.vec', accentAssetPath: 'assets/vectors/line_duotone/headphones-round-accent.vec', accentBehindMain: true);
  static const AuraIconData headphonesRoundSound = AuraIconData('assets/vectors/line_duotone/headphones-round-sound.vec', accentAssetPath: 'assets/vectors/line_duotone/headphones-round-sound-accent.vec', accentBehindMain: true);
  static const AuraIconData headphonesSquare = AuraIconData('assets/vectors/line_duotone/headphones-square.vec', accentAssetPath: 'assets/vectors/line_duotone/headphones-square-accent.vec', accentBehindMain: true);
  static const AuraIconData headphonesSquareSound = AuraIconData('assets/vectors/line_duotone/headphones-square-sound.vec', accentAssetPath: 'assets/vectors/line_duotone/headphones-square-sound-accent.vec');
  static const AuraIconData health = AuraIconData('assets/vectors/line_duotone/health.vec', accentAssetPath: 'assets/vectors/line_duotone/health-accent.vec', accentBehindMain: true);
  static const AuraIconData heart = AuraIconData('assets/vectors/line_duotone/heart.vec', accentAssetPath: 'assets/vectors/line_duotone/heart-accent.vec');
  static const AuraIconData heartAngle = AuraIconData('assets/vectors/line_duotone/heart-angle.vec', accentAssetPath: 'assets/vectors/line_duotone/heart-angle-accent.vec', accentBehindMain: true);
  static const AuraIconData heartCrack = AuraIconData('assets/vectors/line_duotone/heart-crack.vec', accentAssetPath: 'assets/vectors/line_duotone/heart-crack-accent.vec');
  static const AuraIconData heartLock = AuraIconData('assets/vectors/line_duotone/heart-lock.vec', accentAssetPath: 'assets/vectors/line_duotone/heart-lock-accent.vec', accentBehindMain: true);
  static const AuraIconData heartPulse = AuraIconData('assets/vectors/line_duotone/heart-pulse.vec', accentAssetPath: 'assets/vectors/line_duotone/heart-pulse-accent.vec');
  static const AuraIconData heartPulse2 = AuraIconData('assets/vectors/line_duotone/heart-pulse-2.vec', accentAssetPath: 'assets/vectors/line_duotone/heart-pulse-2-accent.vec');
  ...
  static const AuraIconData hikingMinimalistic = AuraIconData('assets/vectors/line_duotone/hiking-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/hiking-minimalistic-accent.vec');
  static const AuraIconData hikingRound = AuraIconData('assets/vectors/line_duotone/hiking-round.vec', accentAssetPath: 'assets/vectors/line_duotone/hiking-round-accent.vec');
  static const AuraIconData history = AuraIconData('assets/vectors/line_duotone/history.vec', accentAssetPath: 'assets/vectors/line_duotone/history-accent.vec', accentBehindMain: true);
  static const AuraIconData history2 = AuraIconData('assets/vectors/line_duotone/history-2.vec', accentAssetPath: 'assets/vectors/line_duotone/history-2-accent.vec');
  static const AuraIconData history3 = AuraIconData('assets/vectors/line_duotone/history-3.vec', accentAssetPath: 'assets/vectors/line_duotone/history-3-accent.vec', accentBehindMain: true);
  static const AuraIconData home = AuraIconData('assets/vectors/line_duotone/home.vec', accentAssetPath: 'assets/vectors/line_duotone/home-accent.vec', accentBehindMain: true);
  static const AuraIconData home2 = AuraIconData('assets/vectors/line_duotone/home-2.vec', accentAssetPath: 'assets/vectors/line_duotone/home-2-accent.vec', accentBehindMain: true);
  static const AuraIconData homeAdd = AuraIconData('assets/vectors/line_duotone/home-add.vec', accentAssetPath: 'assets/vectors/line_duotone/home-add-accent.vec', accentBehindMain: true);
  static const AuraIconData homeAddAngle = AuraIconData('assets/vectors/line_duotone/home-add-angle.vec', accentAssetPath: 'assets/vectors/line_duotone/home-add-angle-accent.vec', accentBehindMain: true);
  static const AuraIconData homeAngle = AuraIconData('assets/vectors/line_duotone/home-angle.vec', accentAssetPath: 'assets/vectors/line_duotone/home-angle-accent.vec', accentBehindMain: true);
  static const AuraIconData homeAngle2 = AuraIconData('assets/vectors/line_duotone/home-angle-2.vec', accentAssetPath: 'assets/vectors/line_duotone/home-angle-2-accent.vec', accentBehindMain: true);
  static const AuraIconData homeSmile = AuraIconData('assets/vectors/line_duotone/home-smile.vec', accentAssetPath: 'assets/vectors/line_duotone/home-smile-accent.vec', accentBehindMain: true);
  static const AuraIconData homeSmileAngle = AuraIconData('assets/vectors/line_duotone/home-smile-angle.vec', accentAssetPath: 'assets/vectors/line_duotone/home-smile-angle-accent.vec', accentBehindMain: true);
  static const AuraIconData homeWiFi = AuraIconData('assets/vectors/line_duotone/home-wi-fi.vec', accentAssetPath: 'assets/vectors/line_duotone/home-wi-fi-accent.vec', accentBehindMain: true);
  static const AuraIconData homeWiFiAngle = AuraIconData('assets/vectors/line_duotone/home-wi-fi-angle.vec', accentAssetPath: 'assets/vectors/line_duotone/home-wi-fi-angle-accent.vec', accentBehindMain: true);
  static const AuraIconData hospital = AuraIconData('assets/vectors/line_duotone/hospital.vec', accentAssetPath: 'assets/vectors/line_duotone/hospital-accent.vec');
  static const AuraIconData hourglass = AuraIconData('assets/vectors/line_duotone/hourglass.vec', accentAssetPath: 'assets/vectors/line_duotone/hourglass-accent.vec');
  static const AuraIconData hourglassLine = AuraIconData('assets/vectors/line_duotone/hourglass-line.vec', accentAssetPath: 'assets/vectors/line_duotone/hourglass-line-accent.vec', accentBehindMain: true);
  static const AuraIconData house = AuraIconData('assets/vectors/line_duotone/house.vec', accentAssetPath: 'assets/vectors/line_duotone/house-accent.vec');
  static const AuraIconData iPhone = AuraIconData('assets/vectors/line_duotone/i-phone.vec', accentAssetPath: 'assets/vectors/line_duotone/i-phone-accent.vec');
  static const AuraIconData importIcon = AuraIconData('assets/vectors/line_duotone/import.vec', accentAssetPath: 'assets/vectors/line_duotone/import-accent.vec', accentBehindMain: true);
  static const AuraIconData inbox = AuraIconData('assets/vectors/line_duotone/inbox.vec', accentAssetPath: 'assets/vectors/line_duotone/inbox-accent.vec');
  static const AuraIconData inboxArchive = AuraIconData('assets/vectors/line_duotone/inbox-archive.vec', accentAssetPath: 'assets/vectors/line_duotone/inbox-archive-accent.vec');
  static const AuraIconData inboxIn = AuraIconData('assets/vectors/line_duotone/inbox-in.vec', accentAssetPath: 'assets/vectors/line_duotone/inbox-in-accent.vec', accentBehindMain: true);
  static const AuraIconData inboxLine = AuraIconData('assets/vectors/line_duotone/inbox-line.vec', accentAssetPath: 'assets/vectors/line_duotone/inbox-line-accent.vec');
  static const AuraIconData inboxOut = AuraIconData('assets/vectors/line_duotone/inbox-out.vec', accentAssetPath: 'assets/vectors/line_duotone/inbox-out-accent.vec');
  ...
  static const AuraIconData keyMinimalisticSquare = AuraIconData('assets/vectors/line_duotone/key-minimalistic-square.vec', accentAssetPath: 'assets/vectors/line_duotone/key-minimalistic-square-accent.vec');
  static const AuraIconData keyMinimalisticSquare2 = AuraIconData('assets/vectors/line_duotone/key-minimalistic-square-2.vec', accentAssetPath: 'assets/vectors/line_duotone/key-minimalistic-square-2-accent.vec');
  static const AuraIconData keyMinimalisticSquare3 = AuraIconData('assets/vectors/line_duotone/key-minimalistic-square-3.vec', accentAssetPath: 'assets/vectors/line_duotone/key-minimalistic-square-3-accent.vec', accentBehindMain: true);
  static const AuraIconData keySquare = AuraIconData('assets/vectors/line_duotone/key-square.vec', accentAssetPath: 'assets/vectors/line_duotone/key-square-accent.vec');
  static const AuraIconData keySquare2 = AuraIconData('assets/vectors/line_duotone/key-square-2.vec', accentAssetPath: 'assets/vectors/line_duotone/key-square-2-accent.vec');
  static const AuraIconData keyboard = AuraIconData('assets/vectors/line_duotone/keyboard.vec', accentAssetPath: 'assets/vectors/line_duotone/keyboard-accent.vec');
  static const AuraIconData kickScooter = AuraIconData('assets/vectors/line_duotone/kick-scooter.vec', accentAssetPath: 'assets/vectors/line_duotone/kick-scooter-accent.vec', accentBehindMain: true);
  static const AuraIconData ladle = AuraIconData('assets/vectors/line_duotone/ladle.vec', accentAssetPath: 'assets/vectors/line_duotone/ladle-accent.vec', accentBehindMain: true);
  static const AuraIconData lamp = AuraIconData('assets/vectors/line_duotone/lamp.vec', accentAssetPath: 'assets/vectors/line_duotone/lamp-accent.vec');
  static const AuraIconData laptop = AuraIconData('assets/vectors/line_duotone/laptop.vec', accentAssetPath: 'assets/vectors/line_duotone/laptop-accent.vec');
  static const AuraIconData laptop2 = AuraIconData('assets/vectors/line_duotone/laptop-2.vec', accentAssetPath: 'assets/vectors/line_duotone/laptop-2-accent.vec', accentBehindMain: true);
  static const AuraIconData laptop3 = AuraIconData('assets/vectors/line_duotone/laptop-3.vec', accentAssetPath: 'assets/vectors/line_duotone/laptop-3-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData letterUnread = AuraIconData('assets/vectors/line_duotone/letter-unread.vec', accentAssetPath: 'assets/vectors/line_duotone/letter-unread-accent.vec', accentBehindMain: true);
  static const AuraIconData libraryIcon = AuraIconData('assets/vectors/line_duotone/library.vec', accentAssetPath: 'assets/vectors/line_duotone/library-accent.vec', accentBehindMain: true);
  static const AuraIconData lightbulb = AuraIconData('assets/vectors/line_duotone/lightbulb.vec', accentAssetPath: 'assets/vectors/line_duotone/lightbulb-accent.vec');
  static const AuraIconData lightbulbBolt = AuraIconData('assets/vectors/line_duotone/lightbulb-bolt.vec', accentAssetPath: 'assets/vectors/line_duotone/lightbulb-bolt-accent.vec');
  static const AuraIconData lightbulbMinimalistic = AuraIconData('assets/vectors/line_duotone/lightbulb-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/lightbulb-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData lightning = AuraIconData('assets/vectors/line_duotone/lightning.vec', accentAssetPath: 'assets/vectors/line_duotone/lightning-accent.vec');
  static const AuraIconData like = AuraIconData('assets/vectors/line_duotone/like.vec', accentAssetPath: 'assets/vectors/line_duotone/like-accent.vec', accentBehindMain: true);
  static const AuraIconData link = AuraIconData('assets/vectors/line_duotone/link.vec', accentAssetPath: 'assets/vectors/line_duotone/link-accent.vec');
  static const AuraIconData linkCircle = AuraIconData('assets/vectors/line_duotone/link-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/link-circle-accent.vec');
  static const AuraIconData linkMinimalistic = AuraIconData('assets/vectors/line_duotone/link-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/link-minimalistic-accent.vec');
  static const AuraIconData linkMinimalistic2 = AuraIconData('assets/vectors/line_duotone/link-minimalistic-2.vec', accentAssetPath: 'assets/vectors/line_duotone/link-minimalistic-2-accent.vec', accentBehindMain: true);
  static const AuraIconData linkRound = AuraIconData('assets/vectors/line_duotone/link-round.vec', accentAssetPath: 'assets/vectors/line_duotone/link-round-accent.vec', accentBehindMain: true);
  static const AuraIconData linkRoundAngle = AuraIconData('assets/vectors/line_duotone/link-round-angle.vec', accentAssetPath: 'assets/vectors/line_duotone/link-round-angle-accent.vec');
  static const AuraIconData linkSquare = AuraIconData('assets/vectors/line_duotone/link-square.vec', accentAssetPath: 'assets/vectors/line_duotone/link-square-accent.vec');
  static const AuraIconData list = AuraIconData('assets/vectors/line_duotone/list.vec', accentAssetPath: 'assets/vectors/line_duotone/list-accent.vec');
  static const AuraIconData listArrowDown = AuraIconData('assets/vectors/line_duotone/list-arrow-down.vec', accentAssetPath: 'assets/vectors/line_duotone/list-arrow-down-accent.vec');
  static const AuraIconData listArrowDownMinimalistic = AuraIconData('assets/vectors/line_duotone/list-arrow-down-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/list-arrow-down-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData listArrowUp = AuraIconData('assets/vectors/line_duotone/list-arrow-up.vec', accentAssetPath: 'assets/vectors/line_duotone/list-arrow-up-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData lockKeyholeMinimalisticUnlocked = AuraIconData('assets/vectors/line_duotone/lock-keyhole-minimalistic-unlocked.vec', accentAssetPath: 'assets/vectors/line_duotone/lock-keyhole-minimalistic-unlocked-accent.vec');
  static const AuraIconData lockKeyholeUnlocked = AuraIconData('assets/vectors/line_duotone/lock-keyhole-unlocked.vec', accentAssetPath: 'assets/vectors/line_duotone/lock-keyhole-unlocked-accent.vec');
  static const AuraIconData lockPassword = AuraIconData('assets/vectors/line_duotone/lock-password.vec', accentAssetPath: 'assets/vectors/line_duotone/lock-password-accent.vec');
  static const AuraIconData lockPasswordUnlocked = AuraIconData('assets/vectors/line_duotone/lock-password-unlocked.vec', accentAssetPath: 'assets/vectors/line_duotone/lock-password-unlocked-accent.vec');
  ...
  static const AuraIconData magnet = AuraIconData('assets/vectors/line_duotone/magnet.vec', accentAssetPath: 'assets/vectors/line_duotone/magnet-accent.vec');
  ...
  static const AuraIconData mapArrowDown = AuraIconData('assets/vectors/line_duotone/map-arrow-down.vec', accentAssetPath: 'assets/vectors/line_duotone/map-arrow-down-accent.vec');
  static const AuraIconData mapArrowLeft = AuraIconData('assets/vectors/line_duotone/map-arrow-left.vec', accentAssetPath: 'assets/vectors/line_duotone/map-arrow-left-accent.vec');
  static const AuraIconData mapArrowRight = AuraIconData('assets/vectors/line_duotone/map-arrow-right.vec', accentAssetPath: 'assets/vectors/line_duotone/map-arrow-right-accent.vec');
  static const AuraIconData mapArrowSquare = AuraIconData('assets/vectors/line_duotone/map-arrow-square.vec', accentAssetPath: 'assets/vectors/line_duotone/map-arrow-square-accent.vec', accentBehindMain: true);
  static const AuraIconData mapArrowUp = AuraIconData('assets/vectors/line_duotone/map-arrow-up.vec', accentAssetPath: 'assets/vectors/line_duotone/map-arrow-up-accent.vec');
  static const AuraIconData mapPoint = AuraIconData('assets/vectors/line_duotone/map-point.vec', accentAssetPath: 'assets/vectors/line_duotone/map-point-accent.vec', accentBehindMain: true);
  static const AuraIconData mapPointAdd = AuraIconData('assets/vectors/line_duotone/map-point-add.vec', accentAssetPath: 'assets/vectors/line_duotone/map-point-add-accent.vec', accentBehindMain: true);
  static const AuraIconData mapPointFavorite = AuraIconData('assets/vectors/line_duotone/map-point-favorite.vec', accentAssetPath: 'assets/vectors/line_duotone/map-point-favorite-accent.vec', accentBehindMain: true);
  static const AuraIconData mapPointHospital = AuraIconData('assets/vectors/line_duotone/map-point-hospital.vec', accentAssetPath: 'assets/vectors/line_duotone/map-point-hospital-accent.vec', accentBehindMain: true);
  static const AuraIconData mapPointRemove = AuraIconData('assets/vectors/line_duotone/map-point-remove.vec', accentAssetPath: 'assets/vectors/line_duotone/map-point-remove-accent.vec', accentBehindMain: true);
  static const AuraIconData mapPointRotate = AuraIconData('assets/vectors/line_duotone/map-point-rotate.vec', accentAssetPath: 'assets/vectors/line_duotone/map-point-rotate-accent.vec', accentBehindMain: true);
  static const AuraIconData mapPointSchool = AuraIconData('assets/vectors/line_duotone/map-point-school.vec', accentAssetPath: 'assets/vectors/line_duotone/map-point-school-accent.vec', accentBehindMain: true);
  static const AuraIconData mapPointSearch = AuraIconData('assets/vectors/line_duotone/map-point-search.vec', accentAssetPath: 'assets/vectors/line_duotone/map-point-search-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData maximizeSquare3 = AuraIconData('assets/vectors/line_duotone/maximize-square-3.vec', accentAssetPath: 'assets/vectors/line_duotone/maximize-square-3-accent.vec', accentBehindMain: true);
  static const AuraIconData maximizeSquareMinimalistic = AuraIconData('assets/vectors/line_duotone/maximize-square-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/maximize-square-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData medalRibbon = AuraIconData('assets/vectors/line_duotone/medal-ribbon.vec', accentAssetPath: 'assets/vectors/line_duotone/medal-ribbon-accent.vec');
  static const AuraIconData medalRibbonStar = AuraIconData('assets/vectors/line_duotone/medal-ribbon-star.vec', accentAssetPath: 'assets/vectors/line_duotone/medal-ribbon-star-accent.vec', accentBehindMain: true);
  static const AuraIconData medalRibbonsStar = AuraIconData('assets/vectors/line_duotone/medal-ribbons-star.vec', accentAssetPath: 'assets/vectors/line_duotone/medal-ribbons-star-accent.vec', accentBehindMain: true);
  static const AuraIconData medalStar = AuraIconData('assets/vectors/line_duotone/medal-star.vec', accentAssetPath: 'assets/vectors/line_duotone/medal-star-accent.vec', accentBehindMain: true);
  static const AuraIconData medalStarCircle = AuraIconData('assets/vectors/line_duotone/medal-star-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/medal-star-circle-accent.vec', accentBehindMain: true);
  static const AuraIconData medalStarSquare = AuraIconData('assets/vectors/line_duotone/medal-star-square.vec', accentAssetPath: 'assets/vectors/line_duotone/medal-star-square-accent.vec', accentBehindMain: true);
  static const AuraIconData medicalKit = AuraIconData('assets/vectors/line_duotone/medical-kit.vec', accentAssetPath: 'assets/vectors/line_duotone/medical-kit-accent.vec');
  static const AuraIconData meditation = AuraIconData('assets/vectors/line_duotone/meditation.vec', accentAssetPath: 'assets/vectors/line_duotone/meditation-accent.vec');
  static const AuraIconData meditationRound = AuraIconData('assets/vectors/line_duotone/meditation-round.vec', accentAssetPath: 'assets/vectors/line_duotone/meditation-round-accent.vec');
  static const AuraIconData men = AuraIconData('assets/vectors/line_duotone/men.vec', accentAssetPath: 'assets/vectors/line_duotone/men-accent.vec');
  static const AuraIconData mentionCircle = AuraIconData('assets/vectors/line_duotone/mention-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/mention-circle-accent.vec');
  static const AuraIconData mentionSquare = AuraIconData('assets/vectors/line_duotone/mention-square.vec', accentAssetPath: 'assets/vectors/line_duotone/mention-square-accent.vec');
  ...
  static const AuraIconData minimizeSquare = AuraIconData('assets/vectors/line_duotone/minimize-square.vec', accentAssetPath: 'assets/vectors/line_duotone/minimize-square-accent.vec');
  ...
  static const AuraIconData mirror2 = AuraIconData('assets/vectors/line_duotone/mirror-2.vec', accentAssetPath: 'assets/vectors/line_duotone/mirror-2-accent.vec', accentBehindMain: true);
  static const AuraIconData mirrorLeft = AuraIconData('assets/vectors/line_duotone/mirror-left.vec', accentAssetPath: 'assets/vectors/line_duotone/mirror-left-accent.vec');
  static const AuraIconData mirrorRight = AuraIconData('assets/vectors/line_duotone/mirror-right.vec', accentAssetPath: 'assets/vectors/line_duotone/mirror-right-accent.vec');
  static const AuraIconData moneyBag = AuraIconData('assets/vectors/line_duotone/money-bag.vec', accentAssetPath: 'assets/vectors/line_duotone/money-bag-accent.vec');
  static const AuraIconData moneyRoll = AuraIconData('assets/vectors/line_duotone/money-roll.vec', accentAssetPath: 'assets/vectors/line_duotone/money-roll-accent.vec');
  ...
  static const AuraIconData musicLibrary2 = AuraIconData('assets/vectors/line_duotone/music-library-2.vec', accentAssetPath: 'assets/vectors/line_duotone/music-library-2-accent.vec');
  static const AuraIconData musicNote = AuraIconData('assets/vectors/line_duotone/music-note.vec', accentAssetPath: 'assets/vectors/line_duotone/music-note-accent.vec');
  static const AuraIconData musicNote2 = AuraIconData('assets/vectors/line_duotone/music-note-2.vec', accentAssetPath: 'assets/vectors/line_duotone/music-note-2-accent.vec', accentBehindMain: true);
  static const AuraIconData musicNote3 = AuraIconData('assets/vectors/line_duotone/music-note-3.vec', accentAssetPath: 'assets/vectors/line_duotone/music-note-3-accent.vec');
  static const AuraIconData musicNote4 = AuraIconData('assets/vectors/line_duotone/music-note-4.vec', accentAssetPath: 'assets/vectors/line_duotone/music-note-4-accent.vec');
  static const AuraIconData musicNoteSlider = AuraIconData('assets/vectors/line_duotone/music-note-slider.vec', accentAssetPath: 'assets/vectors/line_duotone/music-note-slider-accent.vec');
  static const AuraIconData musicNoteSlider2 = AuraIconData('assets/vectors/line_duotone/music-note-slider-2.vec', accentAssetPath: 'assets/vectors/line_duotone/music-note-slider-2-accent.vec');
  ...
  static const AuraIconData notificationLinesRemove = AuraIconData('assets/vectors/line_duotone/notification-lines-remove.vec', accentAssetPath: 'assets/vectors/line_duotone/notification-lines-remove-accent.vec', accentBehindMain: true);
  static const AuraIconData notificationRemove = AuraIconData('assets/vectors/line_duotone/notification-remove.vec', accentAssetPath: 'assets/vectors/line_duotone/notification-remove-accent.vec', accentBehindMain: true);
  static const AuraIconData notificationUnread = AuraIconData('assets/vectors/line_duotone/notification-unread.vec', accentAssetPath: 'assets/vectors/line_duotone/notification-unread-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData passwordMinimalistic = AuraIconData('assets/vectors/line_duotone/password-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/password-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData passwordMinimalisticInput = AuraIconData('assets/vectors/line_duotone/password-minimalistic-input.vec', accentAssetPath: 'assets/vectors/line_duotone/password-minimalistic-input-accent.vec', accentBehindMain: true);
  static const AuraIconData pause = AuraIconData('assets/vectors/line_duotone/pause.vec', accentAssetPath: 'assets/vectors/line_duotone/pause-accent.vec');
  static const AuraIconData pauseCircle = AuraIconData('assets/vectors/line_duotone/pause-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/pause-circle-accent.vec', accentBehindMain: true);
  static const AuraIconData paw = AuraIconData('assets/vectors/line_duotone/paw.vec', accentAssetPath: 'assets/vectors/line_duotone/paw-accent.vec');
  static const AuraIconData pen = AuraIconData('assets/vectors/line_duotone/pen.vec', accentAssetPath: 'assets/vectors/line_duotone/pen-accent.vec');
  static const AuraIconData pen2 = AuraIconData('assets/vectors/line_duotone/pen-2.vec', accentAssetPath: 'assets/vectors/line_duotone/pen-2-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData pill = AuraIconData('assets/vectors/line_duotone/pill.vec', accentAssetPath: 'assets/vectors/line_duotone/pill-accent.vec');
  static const AuraIconData pills = AuraIconData('assets/vectors/line_duotone/pills.vec', accentAssetPath: 'assets/vectors/line_duotone/pills-accent.vec');
  static const AuraIconData pills2 = AuraIconData('assets/vectors/line_duotone/pills-2.vec', accentAssetPath: 'assets/vectors/line_duotone/pills-2-accent.vec');
  static const AuraIconData pills3 = AuraIconData('assets/vectors/line_duotone/pills-3.vec', accentAssetPath: 'assets/vectors/line_duotone/pills-3-accent.vec');
  static const AuraIconData pin = AuraIconData('assets/vectors/line_duotone/pin.vec', accentAssetPath: 'assets/vectors/line_duotone/pin-accent.vec');
  static const AuraIconData pinCircle = AuraIconData('assets/vectors/line_duotone/pin-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/pin-circle-accent.vec', accentBehindMain: true);
  static const AuraIconData pinList = AuraIconData('assets/vectors/line_duotone/pin-list.vec', accentAssetPath: 'assets/vectors/line_duotone/pin-list-accent.vec');
  static const AuraIconData pip = AuraIconData('assets/vectors/line_duotone/pip.vec', accentAssetPath: 'assets/vectors/line_duotone/pip-accent.vec', accentBehindMain: true);
  static const AuraIconData pip2 = AuraIconData('assets/vectors/line_duotone/pip-2.vec', accentAssetPath: 'assets/vectors/line_duotone/pip-2-accent.vec', accentBehindMain: true);
  static const AuraIconData pipette = AuraIconData('assets/vectors/line_duotone/pipette.vec', accentAssetPath: 'assets/vectors/line_duotone/pipette-accent.vec');
  static const AuraIconData plane = AuraIconData('assets/vectors/line_duotone/plane.vec', accentAssetPath: 'assets/vectors/line_duotone/plane-accent.vec');
  static const AuraIconData plane2 = AuraIconData('assets/vectors/line_duotone/plane-2.vec', accentAssetPath: 'assets/vectors/line_duotone/plane-2-accent.vec');
  static const AuraIconData plane3 = AuraIconData('assets/vectors/line_duotone/plane-3.vec', accentAssetPath: 'assets/vectors/line_duotone/plane-3-accent.vec');
  ...
  static const AuraIconData playlist = AuraIconData('assets/vectors/line_duotone/playlist.vec', accentAssetPath: 'assets/vectors/line_duotone/playlist-accent.vec', accentBehindMain: true);
  static const AuraIconData playlist2 = AuraIconData('assets/vectors/line_duotone/playlist-2.vec', accentAssetPath: 'assets/vectors/line_duotone/playlist-2-accent.vec');
  static const AuraIconData playlistMinimalistic = AuraIconData('assets/vectors/line_duotone/playlist-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/playlist-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData playlistMinimalistic2 = AuraIconData('assets/vectors/line_duotone/playlist-minimalistic-2.vec', accentAssetPath: 'assets/vectors/line_duotone/playlist-minimalistic-2-accent.vec', accentBehindMain: true);
  static const AuraIconData playlistMinimalistic3 = AuraIconData('assets/vectors/line_duotone/playlist-minimalistic-3.vec', accentAssetPath: 'assets/vectors/line_duotone/playlist-minimalistic-3-accent.vec', accentBehindMain: true);
  static const AuraIconData plugCircle = AuraIconData('assets/vectors/line_duotone/plug-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/plug-circle-accent.vec', accentBehindMain: true);
  static const AuraIconData plusMinus = AuraIconData('assets/vectors/line_duotone/plus-minus.vec', accentAssetPath: 'assets/vectors/line_duotone/plus-minus-accent.vec');
  static const AuraIconData podcast = AuraIconData('assets/vectors/line_duotone/podcast.vec', accentAssetPath: 'assets/vectors/line_duotone/podcast-accent.vec');
  static const AuraIconData pointOnMap = AuraIconData('assets/vectors/line_duotone/point-on-map.vec', accentAssetPath: 'assets/vectors/line_duotone/point-on-map-accent.vec', accentBehindMain: true);
  static const AuraIconData pointOnMapPerspective = AuraIconData('assets/vectors/line_duotone/point-on-map-perspective.vec', accentAssetPath: 'assets/vectors/line_duotone/point-on-map-perspective-accent.vec', accentBehindMain: true);
  static const AuraIconData postsCarouselHorizontal = AuraIconData('assets/vectors/line_duotone/posts-carousel-horizontal.vec', accentAssetPath: 'assets/vectors/line_duotone/posts-carousel-horizontal-accent.vec');
  ...
  static const AuraIconData radioMinimalistic = AuraIconData('assets/vectors/line_duotone/radio-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/radio-minimalistic-accent.vec');
  ...
  static const AuraIconData recordSquare = AuraIconData('assets/vectors/line_duotone/record-square.vec', accentAssetPath: 'assets/vectors/line_duotone/record-square-accent.vec');
  static const AuraIconData reel = AuraIconData('assets/vectors/line_duotone/reel.vec', accentAssetPath: 'assets/vectors/line_duotone/reel-accent.vec');
  static const AuraIconData reel2 = AuraIconData('assets/vectors/line_duotone/reel-2.vec', accentAssetPath: 'assets/vectors/line_duotone/reel-2-accent.vec');
  static const AuraIconData refresh = AuraIconData('assets/vectors/line_duotone/refresh.vec', accentAssetPath: 'assets/vectors/line_duotone/refresh-accent.vec');
  static const AuraIconData refreshCircle = AuraIconData('assets/vectors/line_duotone/refresh-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/refresh-circle-accent.vec');
  static const AuraIconData refreshSquare = AuraIconData('assets/vectors/line_duotone/refresh-square.vec', accentAssetPath: 'assets/vectors/line_duotone/refresh-square-accent.vec');
  static const AuraIconData remoteController = AuraIconData('assets/vectors/line_duotone/remote-controller.vec', accentAssetPath: 'assets/vectors/line_duotone/remote-controller-accent.vec', accentBehindMain: true);
  static const AuraIconData remoteController2 = AuraIconData('assets/vectors/line_duotone/remote-controller-2.vec', accentAssetPath: 'assets/vectors/line_duotone/remote-controller-2-accent.vec', accentBehindMain: true);
  static const AuraIconData remoteControllerMinimalistic = AuraIconData('assets/vectors/line_duotone/remote-controller-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/remote-controller-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData removeFolder = AuraIconData('assets/vectors/line_duotone/remove-folder.vec', accentAssetPath: 'assets/vectors/line_duotone/remove-folder-accent.vec', accentBehindMain: true);
  static const AuraIconData reorder = AuraIconData('assets/vectors/line_duotone/reorder.vec', accentAssetPath: 'assets/vectors/line_duotone/reorder-accent.vec');
  static const AuraIconData reorder2 = AuraIconData('assets/vectors/line_duotone/reorder-2.vec', accentAssetPath: 'assets/vectors/line_duotone/reorder-2-accent.vec');
  static const AuraIconData repeat = AuraIconData('assets/vectors/line_duotone/repeat.vec', accentAssetPath: 'assets/vectors/line_duotone/repeat-accent.vec');
  static const AuraIconData repeatOne = AuraIconData('assets/vectors/line_duotone/repeat-one.vec', accentAssetPath: 'assets/vectors/line_duotone/repeat-one-accent.vec');
  ...
  static const AuraIconData rewind10SecondsBack = AuraIconData('assets/vectors/line_duotone/rewind-10-seconds-back.vec', accentAssetPath: 'assets/vectors/line_duotone/rewind-10-seconds-back-accent.vec', accentBehindMain: true);
  static const AuraIconData rewind10SecondsForward = AuraIconData('assets/vectors/line_duotone/rewind-10-seconds-forward.vec', accentAssetPath: 'assets/vectors/line_duotone/rewind-10-seconds-forward-accent.vec', accentBehindMain: true);
  static const AuraIconData rewind15SecondsBack = AuraIconData('assets/vectors/line_duotone/rewind-15-seconds-back.vec', accentAssetPath: 'assets/vectors/line_duotone/rewind-15-seconds-back-accent.vec', accentBehindMain: true);
  static const AuraIconData rewind15SecondsForward = AuraIconData('assets/vectors/line_duotone/rewind-15-seconds-forward.vec', accentAssetPath: 'assets/vectors/line_duotone/rewind-15-seconds-forward-accent.vec', accentBehindMain: true);
  static const AuraIconData rewind5SecondsBack = AuraIconData('assets/vectors/line_duotone/rewind-5-seconds-back.vec', accentAssetPath: 'assets/vectors/line_duotone/rewind-5-seconds-back-accent.vec', accentBehindMain: true);
  static const AuraIconData rewind5SecondsForward = AuraIconData('assets/vectors/line_duotone/rewind-5-seconds-forward.vec', accentAssetPath: 'assets/vectors/line_duotone/rewind-5-seconds-forward-accent.vec', accentBehindMain: true);
  static const AuraIconData rewindBack = AuraIconData('assets/vectors/line_duotone/rewind-back.vec', accentAssetPath: 'assets/vectors/line_duotone/rewind-back-accent.vec', accentBehindMain: true);
  static const AuraIconData rewindBackCircle = AuraIconData('assets/vectors/line_duotone/rewind-back-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/rewind-back-circle-accent.vec', accentBehindMain: true);
  static const AuraIconData rewindForward = AuraIconData('assets/vectors/line_duotone/rewind-forward.vec', accentAssetPath: 'assets/vectors/line_duotone/rewind-forward-accent.vec', accentBehindMain: true);
  static const AuraIconData rewindForwardCircle = AuraIconData('assets/vectors/line_duotone/rewind-forward-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/rewind-forward-circle-accent.vec', accentBehindMain: true);
  static const AuraIconData rocket = AuraIconData('assets/vectors/line_duotone/rocket.vec', accentAssetPath: 'assets/vectors/line_duotone/rocket-accent.vec');
  static const AuraIconData rocket2 = AuraIconData('assets/vectors/line_duotone/rocket-2.vec', accentAssetPath: 'assets/vectors/line_duotone/rocket-2-accent.vec');
  static const AuraIconData rollingPin = AuraIconData('assets/vectors/line_duotone/rolling-pin.vec', accentAssetPath: 'assets/vectors/line_duotone/rolling-pin-accent.vec');
  static const AuraIconData roundAltArrowDown = AuraIconData('assets/vectors/line_duotone/round-alt-arrow-down.vec', accentAssetPath: 'assets/vectors/line_duotone/round-alt-arrow-down-accent.vec', accentBehindMain: true);
  static const AuraIconData roundAltArrowLeft = AuraIconData('assets/vectors/line_duotone/round-alt-arrow-left.vec', accentAssetPath: 'assets/vectors/line_duotone/round-alt-arrow-left-accent.vec', accentBehindMain: true);
  static const AuraIconData roundAltArrowRight = AuraIconData('assets/vectors/line_duotone/round-alt-arrow-right.vec', accentAssetPath: 'assets/vectors/line_duotone/round-alt-arrow-right-accent.vec', accentBehindMain: true);
  static const AuraIconData roundAltArrowUp = AuraIconData('assets/vectors/line_duotone/round-alt-arrow-up.vec', accentAssetPath: 'assets/vectors/line_duotone/round-alt-arrow-up-accent.vec', accentBehindMain: true);
  static const AuraIconData roundArrowDown = AuraIconData('assets/vectors/line_duotone/round-arrow-down.vec', accentAssetPath: 'assets/vectors/line_duotone/round-arrow-down-accent.vec', accentBehindMain: true);
  static const AuraIconData roundArrowLeft = AuraIconData('assets/vectors/line_duotone/round-arrow-left.vec', accentAssetPath: 'assets/vectors/line_duotone/round-arrow-left-accent.vec', accentBehindMain: true);
  static const AuraIconData roundArrowLeftDown = AuraIconData('assets/vectors/line_duotone/round-arrow-left-down.vec', accentAssetPath: 'assets/vectors/line_duotone/round-arrow-left-down-accent.vec', accentBehindMain: true);
  static const AuraIconData roundArrowLeftUp = AuraIconData('assets/vectors/line_duotone/round-arrow-left-up.vec', accentAssetPath: 'assets/vectors/line_duotone/round-arrow-left-up-accent.vec', accentBehindMain: true);
  static const AuraIconData roundArrowRight = AuraIconData('assets/vectors/line_duotone/round-arrow-right.vec', accentAssetPath: 'assets/vectors/line_duotone/round-arrow-right-accent.vec', accentBehindMain: true);
  static const AuraIconData roundArrowRightDown = AuraIconData('assets/vectors/line_duotone/round-arrow-right-down.vec', accentAssetPath: 'assets/vectors/line_duotone/round-arrow-right-down-accent.vec', accentBehindMain: true);
  static const AuraIconData roundArrowRightUp = AuraIconData('assets/vectors/line_duotone/round-arrow-right-up.vec', accentAssetPath: 'assets/vectors/line_duotone/round-arrow-right-up-accent.vec', accentBehindMain: true);
  static const AuraIconData roundArrowUp = AuraIconData('assets/vectors/line_duotone/round-arrow-up.vec', accentAssetPath: 'assets/vectors/line_duotone/round-arrow-up-accent.vec', accentBehindMain: true);
  static const AuraIconData roundDoubleAltArrowDown = AuraIconData('assets/vectors/line_duotone/round-double-alt-arrow-down.vec', accentAssetPath: 'assets/vectors/line_duotone/round-double-alt-arrow-down-accent.vec', accentBehindMain: true);
  static const AuraIconData roundDoubleAltArrowLeft = AuraIconData('assets/vectors/line_duotone/round-double-alt-arrow-left.vec', accentAssetPath: 'assets/vectors/line_duotone/round-double-alt-arrow-left-accent.vec', accentBehindMain: true);
  static const AuraIconData roundDoubleAltArrowRight = AuraIconData('assets/vectors/line_duotone/round-double-alt-arrow-right.vec', accentAssetPath: 'assets/vectors/line_duotone/round-double-alt-arrow-right-accent.vec', accentBehindMain: true);
  static const AuraIconData roundDoubleAltArrowUp = AuraIconData('assets/vectors/line_duotone/round-double-alt-arrow-up.vec', accentAssetPath: 'assets/vectors/line_duotone/round-double-alt-arrow-up-accent.vec', accentBehindMain: true);
  static const AuraIconData roundGraph = AuraIconData('assets/vectors/line_duotone/round-graph.vec', accentAssetPath: 'assets/vectors/line_duotone/round-graph-accent.vec', accentBehindMain: true);
  static const AuraIconData roundSortHorizontal = AuraIconData('assets/vectors/line_duotone/round-sort-horizontal.vec', accentAssetPath: 'assets/vectors/line_duotone/round-sort-horizontal-accent.vec', accentBehindMain: true);
  static const AuraIconData roundSortVertical = AuraIconData('assets/vectors/line_duotone/round-sort-vertical.vec', accentAssetPath: 'assets/vectors/line_duotone/round-sort-vertical-accent.vec', accentBehindMain: true);
  static const AuraIconData roundTransferDiagonal = AuraIconData('assets/vectors/line_duotone/round-transfer-diagonal.vec', accentAssetPath: 'assets/vectors/line_duotone/round-transfer-diagonal-accent.vec', accentBehindMain: true);
  static const AuraIconData roundTransferHorizontal = AuraIconData('assets/vectors/line_duotone/round-transfer-horizontal.vec', accentAssetPath: 'assets/vectors/line_duotone/round-transfer-horizontal-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData rulerAngular = AuraIconData('assets/vectors/line_duotone/ruler-angular.vec', accentAssetPath: 'assets/vectors/line_duotone/ruler-angular-accent.vec');
  static const AuraIconData rulerCrossPen = AuraIconData('assets/vectors/line_duotone/ruler-cross-pen.vec', accentAssetPath: 'assets/vectors/line_duotone/ruler-cross-pen-accent.vec', accentBehindMain: true);
  static const AuraIconData rulerPen = AuraIconData('assets/vectors/line_duotone/ruler-pen.vec', accentAssetPath: 'assets/vectors/line_duotone/ruler-pen-accent.vec');
  static const AuraIconData running = AuraIconData('assets/vectors/line_duotone/running.vec', accentAssetPath: 'assets/vectors/line_duotone/running-accent.vec', accentBehindMain: true);
  static const AuraIconData running2 = AuraIconData('assets/vectors/line_duotone/running-2.vec', accentAssetPath: 'assets/vectors/line_duotone/running-2-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData saleSquare = AuraIconData('assets/vectors/line_duotone/sale-square.vec', accentAssetPath: 'assets/vectors/line_duotone/sale-square-accent.vec');
  static const AuraIconData satellite = AuraIconData('assets/vectors/line_duotone/satellite.vec', accentAssetPath: 'assets/vectors/line_duotone/satellite-accent.vec', accentBehindMain: true);
  static const AuraIconData scale = AuraIconData('assets/vectors/line_duotone/scale.vec', accentAssetPath: 'assets/vectors/line_duotone/scale-accent.vec', accentBehindMain: true);
  static const AuraIconData scaling = AuraIconData('assets/vectors/line_duotone/scaling.vec', accentAssetPath: 'assets/vectors/line_duotone/scaling-accent.vec', accentBehindMain: true);
  static const AuraIconData scanner = AuraIconData('assets/vectors/line_duotone/scanner.vec', accentAssetPath: 'assets/vectors/line_duotone/scanner-accent.vec', accentBehindMain: true);
  static const AuraIconData scanner2 = AuraIconData('assets/vectors/line_duotone/scanner-2.vec', accentAssetPath: 'assets/vectors/line_duotone/scanner-2-accent.vec');
  ...
  static const AuraIconData serverPath = AuraIconData('assets/vectors/line_duotone/server-path.vec', accentAssetPath: 'assets/vectors/line_duotone/server-path-accent.vec', accentBehindMain: true);
  static const AuraIconData serverSquare = AuraIconData('assets/vectors/line_duotone/server-square.vec', accentAssetPath: 'assets/vectors/line_duotone/server-square-accent.vec', accentBehindMain: true);
  static const AuraIconData serverSquareCloud = AuraIconData('assets/vectors/line_duotone/server-square-cloud.vec', accentAssetPath: 'assets/vectors/line_duotone/server-square-cloud-accent.vec', accentBehindMain: true);
  static const AuraIconData serverSquareUpdate = AuraIconData('assets/vectors/line_duotone/server-square-update.vec', accentAssetPath: 'assets/vectors/line_duotone/server-square-update-accent.vec', accentBehindMain: true);
  static const AuraIconData settings = AuraIconData('assets/vectors/line_duotone/settings.vec', accentAssetPath: 'assets/vectors/line_duotone/settings-accent.vec');
  ...
  static const AuraIconData shieldKeyhole = AuraIconData('assets/vectors/line_duotone/shield-keyhole.vec', accentAssetPath: 'assets/vectors/line_duotone/shield-keyhole-accent.vec', accentBehindMain: true);
  static const AuraIconData shieldKeyholeMinimalistic = AuraIconData('assets/vectors/line_duotone/shield-keyhole-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/shield-keyhole-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData shieldMinimalistic = AuraIconData('assets/vectors/line_duotone/shield-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/shield-minimalistic-accent.vec');
  static const AuraIconData shieldMinus = AuraIconData('assets/vectors/line_duotone/shield-minus.vec', accentAssetPath: 'assets/vectors/line_duotone/shield-minus-accent.vec', accentBehindMain: true);
  static const AuraIconData shieldNetwork = AuraIconData('assets/vectors/line_duotone/shield-network.vec', accentAssetPath: 'assets/vectors/line_duotone/shield-network-accent.vec', accentBehindMain: true);
  static const AuraIconData shieldPlus = AuraIconData('assets/vectors/line_duotone/shield-plus.vec', accentAssetPath: 'assets/vectors/line_duotone/shield-plus-accent.vec', accentBehindMain: true);
  static const AuraIconData shieldStar = AuraIconData('assets/vectors/line_duotone/shield-star.vec', accentAssetPath: 'assets/vectors/line_duotone/shield-star-accent.vec', accentBehindMain: true);
  static const AuraIconData shieldUp = AuraIconData('assets/vectors/line_duotone/shield-up.vec', accentAssetPath: 'assets/vectors/line_duotone/shield-up-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData simCardMinimalistic = AuraIconData('assets/vectors/line_duotone/sim-card-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/sim-card-minimalistic-accent.vec');
  static const AuraIconData simCards = AuraIconData('assets/vectors/line_duotone/sim-cards.vec', accentAssetPath: 'assets/vectors/line_duotone/sim-cards-accent.vec');
  static const AuraIconData siren = AuraIconData('assets/vectors/line_duotone/siren.vec', accentAssetPath: 'assets/vectors/line_duotone/siren-accent.vec', accentBehindMain: true);
  static const AuraIconData sirenRounded = AuraIconData('assets/vectors/line_duotone/siren-rounded.vec', accentAssetPath: 'assets/vectors/line_duotone/siren-rounded-accent.vec', accentBehindMain: true);
  static const AuraIconData skateboard = AuraIconData('assets/vectors/line_duotone/skateboard.vec', accentAssetPath: 'assets/vectors/line_duotone/skateboard-accent.vec', accentBehindMain: true);
  static const AuraIconData skateboarding = AuraIconData('assets/vectors/line_duotone/skateboarding.vec', accentAssetPath: 'assets/vectors/line_duotone/skateboarding-accent.vec');
  static const AuraIconData skateboardingRound = AuraIconData('assets/vectors/line_duotone/skateboarding-round.vec', accentAssetPath: 'assets/vectors/line_duotone/skateboarding-round-accent.vec');
  static const AuraIconData skipNext = AuraIconData('assets/vectors/line_duotone/skip-next.vec', accentAssetPath: 'assets/vectors/line_duotone/skip-next-accent.vec');
  static const AuraIconData skipPrevious = AuraIconData('assets/vectors/line_duotone/skip-previous.vec', accentAssetPath: 'assets/vectors/line_duotone/skip-previous-accent.vec');
  static const AuraIconData skirt = AuraIconData('assets/vectors/line_duotone/skirt.vec', accentAssetPath: 'assets/vectors/line_duotone/skirt-accent.vec');
  static const AuraIconData slashCircle = AuraIconData('assets/vectors/line_duotone/slash-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/slash-circle-accent.vec');
  static const AuraIconData slashSquare = AuraIconData('assets/vectors/line_duotone/slash-square.vec', accentAssetPath: 'assets/vectors/line_duotone/slash-square-accent.vec');
  static const AuraIconData sledgehammer = AuraIconData('assets/vectors/line_duotone/sledgehammer.vec', accentAssetPath: 'assets/vectors/line_duotone/sledgehammer-accent.vec');
  static const AuraIconData sleeping = AuraIconData('assets/vectors/line_duotone/sleeping.vec', accentAssetPath: 'assets/vectors/line_duotone/sleeping-accent.vec');
  static const AuraIconData sleepingCircle = AuraIconData('assets/vectors/line_duotone/sleeping-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/sleeping-circle-accent.vec');
  static const AuraIconData sleepingSquare = AuraIconData('assets/vectors/line_duotone/sleeping-square.vec', accentAssetPath: 'assets/vectors/line_duotone/sleeping-square-accent.vec');
  static const AuraIconData sliderHorizontal = AuraIconData('assets/vectors/line_duotone/slider-horizontal.vec', accentAssetPath: 'assets/vectors/line_duotone/slider-horizontal-accent.vec');
  static const AuraIconData sliderMinimalisticHorizontal = AuraIconData('assets/vectors/line_duotone/slider-minimalistic-horizontal.vec', accentAssetPath: 'assets/vectors/line_duotone/slider-minimalistic-horizontal-accent.vec');
  static const AuraIconData sliderVertical = AuraIconData('assets/vectors/line_duotone/slider-vertical.vec', accentAssetPath: 'assets/vectors/line_duotone/slider-vertical-accent.vec');
  ...
  static const AuraIconData smartphoneRotate2 = AuraIconData('assets/vectors/line_duotone/smartphone-rotate-2.vec', accentAssetPath: 'assets/vectors/line_duotone/smartphone-rotate-2-accent.vec');
  static const AuraIconData smartphoneRotateAngle = AuraIconData('assets/vectors/line_duotone/smartphone-rotate-angle.vec', accentAssetPath: 'assets/vectors/line_duotone/smartphone-rotate-angle-accent.vec', accentBehindMain: true);
  static const AuraIconData smartphoneRotateOrientation = AuraIconData('assets/vectors/line_duotone/smartphone-rotate-orientation.vec', accentAssetPath: 'assets/vectors/line_duotone/smartphone-rotate-orientation-accent.vec');
  static const AuraIconData smartphoneUpdate = AuraIconData('assets/vectors/line_duotone/smartphone-update.vec', accentAssetPath: 'assets/vectors/line_duotone/smartphone-update-accent.vec');
  static const AuraIconData smartphoneVibration = AuraIconData('assets/vectors/line_duotone/smartphone-vibration.vec', accentAssetPath: 'assets/vectors/line_duotone/smartphone-vibration-accent.vec');
  static const AuraIconData smileCircle = AuraIconData('assets/vectors/line_duotone/smile-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/smile-circle-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData sortByTime = AuraIconData('assets/vectors/line_duotone/sort-by-time.vec', accentAssetPath: 'assets/vectors/line_duotone/sort-by-time-accent.vec', accentBehindMain: true);
  static const AuraIconData sortFromBottomToTop = AuraIconData('assets/vectors/line_duotone/sort-from-bottom-to-top.vec', accentAssetPath: 'assets/vectors/line_duotone/sort-from-bottom-to-top-accent.vec');
  static const AuraIconData sortFromTopToBottom = AuraIconData('assets/vectors/line_duotone/sort-from-top-to-bottom.vec', accentAssetPath: 'assets/vectors/line_duotone/sort-from-top-to-bottom-accent.vec');
  static const AuraIconData sortHorizontal = AuraIconData('assets/vectors/line_duotone/sort-horizontal.vec', accentAssetPath: 'assets/vectors/line_duotone/sort-horizontal-accent.vec');
  static const AuraIconData sortVertical = AuraIconData('assets/vectors/line_duotone/sort-vertical.vec', accentAssetPath: 'assets/vectors/line_duotone/sort-vertical-accent.vec', accentBehindMain: true);
  static const AuraIconData soundwave = AuraIconData('assets/vectors/line_duotone/soundwave.vec', accentAssetPath: 'assets/vectors/line_duotone/soundwave-accent.vec');
  static const AuraIconData soundwaveCircle = AuraIconData('assets/vectors/line_duotone/soundwave-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/soundwave-circle-accent.vec');
  static const AuraIconData soundwaveSquare = AuraIconData('assets/vectors/line_duotone/soundwave-square.vec', accentAssetPath: 'assets/vectors/line_duotone/soundwave-square-accent.vec');
  static const AuraIconData speaker = AuraIconData('assets/vectors/line_duotone/speaker.vec', accentAssetPath: 'assets/vectors/line_duotone/speaker-accent.vec', accentBehindMain: true);
  static const AuraIconData speakerMinimalistic = AuraIconData('assets/vectors/line_duotone/speaker-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/speaker-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData specialEffects = AuraIconData('assets/vectors/line_duotone/special-effects.vec', accentAssetPath: 'assets/vectors/line_duotone/special-effects-accent.vec', accentBehindMain: true);
  static const AuraIconData speedometerLow = AuraIconData('assets/vectors/line_duotone/speedometer-low.vec', accentAssetPath: 'assets/vectors/line_duotone/speedometer-low-accent.vec');
  static const AuraIconData speedometerMax = AuraIconData('assets/vectors/line_duotone/speedometer-max.vec', accentAssetPath: 'assets/vectors/line_duotone/speedometer-max-accent.vec');
  static const AuraIconData speedometerMiddle = AuraIconData('assets/vectors/line_duotone/speedometer-middle.vec', accentAssetPath: 'assets/vectors/line_duotone/speedometer-middle-accent.vec');
  static const AuraIconData squareAcademicCap = AuraIconData('assets/vectors/line_duotone/square-academic-cap.vec', accentAssetPath: 'assets/vectors/line_duotone/square-academic-cap-accent.vec');
  static const AuraIconData squareAcademicCap2 = AuraIconData('assets/vectors/line_duotone/square-academic-cap-2.vec', accentAssetPath: 'assets/vectors/line_duotone/square-academic-cap-2-accent.vec');
  static const AuraIconData squareAltArrowDown = AuraIconData('assets/vectors/line_duotone/square-alt-arrow-down.vec', accentAssetPath: 'assets/vectors/line_duotone/square-alt-arrow-down-accent.vec');
  static const AuraIconData squareAltArrowLeft = AuraIconData('assets/vectors/line_duotone/square-alt-arrow-left.vec', accentAssetPath: 'assets/vectors/line_duotone/square-alt-arrow-left-accent.vec');
  static const AuraIconData squareAltArrowRight = AuraIconData('assets/vectors/line_duotone/square-alt-arrow-right.vec', accentAssetPath: 'assets/vectors/line_duotone/square-alt-arrow-right-accent.vec');
  static const AuraIconData squareAltArrowUp = AuraIconData('assets/vectors/line_duotone/square-alt-arrow-up.vec', accentAssetPath: 'assets/vectors/line_duotone/square-alt-arrow-up-accent.vec');
  static const AuraIconData squareArrowDown = AuraIconData('assets/vectors/line_duotone/square-arrow-down.vec', accentAssetPath: 'assets/vectors/line_duotone/square-arrow-down-accent.vec');
  static const AuraIconData squareArrowLeft = AuraIconData('assets/vectors/line_duotone/square-arrow-left.vec', accentAssetPath: 'assets/vectors/line_duotone/square-arrow-left-accent.vec');
  static const AuraIconData squareArrowLeftDown = AuraIconData('assets/vectors/line_duotone/square-arrow-left-down.vec', accentAssetPath: 'assets/vectors/line_duotone/square-arrow-left-down-accent.vec');
  static const AuraIconData squareArrowLeftUp = AuraIconData('assets/vectors/line_duotone/square-arrow-left-up.vec', accentAssetPath: 'assets/vectors/line_duotone/square-arrow-left-up-accent.vec');
  static const AuraIconData squareArrowRight = AuraIconData('assets/vectors/line_duotone/square-arrow-right.vec', accentAssetPath: 'assets/vectors/line_duotone/square-arrow-right-accent.vec');
  static const AuraIconData squareArrowRightDown = AuraIconData('assets/vectors/line_duotone/square-arrow-right-down.vec', accentAssetPath: 'assets/vectors/line_duotone/square-arrow-right-down-accent.vec');
  static const AuraIconData squareArrowRightUp = AuraIconData('assets/vectors/line_duotone/square-arrow-right-up.vec', accentAssetPath: 'assets/vectors/line_duotone/square-arrow-right-up-accent.vec');
  ...
  static const AuraIconData squareDoubleAltArrowUp = AuraIconData('assets/vectors/line_duotone/square-double-alt-arrow-up.vec', accentAssetPath: 'assets/vectors/line_duotone/square-double-alt-arrow-up-accent.vec', accentBehindMain: true);
  static const AuraIconData squareForward = AuraIconData('assets/vectors/line_duotone/square-forward.vec', accentAssetPath: 'assets/vectors/line_duotone/square-forward-accent.vec', accentBehindMain: true);
  static const AuraIconData squareShareLine = AuraIconData('assets/vectors/line_duotone/square-share-line.vec', accentAssetPath: 'assets/vectors/line_duotone/square-share-line-accent.vec', accentBehindMain: true);
  static const AuraIconData squareSortHorizontal = AuraIconData('assets/vectors/line_duotone/square-sort-horizontal.vec', accentAssetPath: 'assets/vectors/line_duotone/square-sort-horizontal-accent.vec', accentBehindMain: true);
  static const AuraIconData squareSortVertical = AuraIconData('assets/vectors/line_duotone/square-sort-vertical.vec', accentAssetPath: 'assets/vectors/line_duotone/square-sort-vertical-accent.vec', accentBehindMain: true);
  static const AuraIconData squareTopDown = AuraIconData('assets/vectors/line_duotone/square-top-down.vec', accentAssetPath: 'assets/vectors/line_duotone/square-top-down-accent.vec');
  static const AuraIconData squareTopUp = AuraIconData('assets/vectors/line_duotone/square-top-up.vec', accentAssetPath: 'assets/vectors/line_duotone/square-top-up-accent.vec');
  static const AuraIconData squareTransferHorizontal = AuraIconData('assets/vectors/line_duotone/square-transfer-horizontal.vec', accentAssetPath: 'assets/vectors/line_duotone/square-transfer-horizontal-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData stars = AuraIconData('assets/vectors/line_duotone/stars.vec', accentAssetPath: 'assets/vectors/line_duotone/stars-accent.vec');
  static const AuraIconData stars2 = AuraIconData('assets/vectors/line_duotone/stars-2.vec', accentAssetPath: 'assets/vectors/line_duotone/stars-2-accent.vec', accentBehindMain: true);
  static const AuraIconData starsLine = AuraIconData('assets/vectors/line_duotone/stars-line.vec', accentAssetPath: 'assets/vectors/line_duotone/stars-line-accent.vec');
  static const AuraIconData starsMinimalistic = AuraIconData('assets/vectors/line_duotone/stars-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/stars-minimalistic-accent.vec');
  static const AuraIconData station = AuraIconData('assets/vectors/line_duotone/station.vec', accentAssetPath: 'assets/vectors/line_duotone/station-accent.vec', accentBehindMain: true);
  static const AuraIconData stationMinimalistic = AuraIconData('assets/vectors/line_duotone/station-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/station-minimalistic-accent.vec');
  static const AuraIconData stethoscope = AuraIconData('assets/vectors/line_duotone/stethoscope.vec', accentAssetPath: 'assets/vectors/line_duotone/stethoscope-accent.vec', accentBehindMain: true);
  static const AuraIconData stickerCircle = AuraIconData('assets/vectors/line_duotone/sticker-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/sticker-circle-accent.vec');
  static const AuraIconData stickerSmileCircle = AuraIconData('assets/vectors/line_duotone/sticker-smile-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/sticker-smile-circle-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData stopwatchPlay = AuraIconData('assets/vectors/line_duotone/stopwatch-play.vec', accentAssetPath: 'assets/vectors/line_duotone/stopwatch-play-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData subtitles = AuraIconData('assets/vectors/line_duotone/subtitles.vec', accentAssetPath: 'assets/vectors/line_duotone/subtitles-accent.vec', accentBehindMain: true);
  static const AuraIconData suitcase = AuraIconData('assets/vectors/line_duotone/suitcase.vec', accentAssetPath: 'assets/vectors/line_duotone/suitcase-accent.vec');
  static const AuraIconData suitcaseLines = AuraIconData('assets/vectors/line_duotone/suitcase-lines.vec', accentAssetPath: 'assets/vectors/line_duotone/suitcase-lines-accent.vec');
  static const AuraIconData suitcaseTag = AuraIconData('assets/vectors/line_duotone/suitcase-tag.vec', accentAssetPath: 'assets/vectors/line_duotone/suitcase-tag-accent.vec');
  static const AuraIconData sun = AuraIconData('assets/vectors/line_duotone/sun.vec', accentAssetPath: 'assets/vectors/line_duotone/sun-accent.vec');
  static const AuraIconData sun2 = AuraIconData('assets/vectors/line_duotone/sun-2.vec', accentAssetPath: 'assets/vectors/line_duotone/sun-2-accent.vec');
  static const AuraIconData sunFog = AuraIconData('assets/vectors/line_duotone/sun-fog.vec', accentAssetPath: 'assets/vectors/line_duotone/sun-fog-accent.vec');
  static const AuraIconData sunrise = AuraIconData('assets/vectors/line_duotone/sunrise.vec', accentAssetPath: 'assets/vectors/line_duotone/sunrise-accent.vec');
  static const AuraIconData sunset = AuraIconData('assets/vectors/line_duotone/sunset.vec', accentAssetPath: 'assets/vectors/line_duotone/sunset-accent.vec');
  static const AuraIconData suspension = AuraIconData('assets/vectors/line_duotone/suspension.vec', accentAssetPath: 'assets/vectors/line_duotone/suspension-accent.vec');
  static const AuraIconData suspensionBolt = AuraIconData('assets/vectors/line_duotone/suspension-bolt.vec', accentAssetPath: 'assets/vectors/line_duotone/suspension-bolt-accent.vec');
  ...
  static const AuraIconData tagPrice = AuraIconData('assets/vectors/line_duotone/tag-price.vec', accentAssetPath: 'assets/vectors/line_duotone/tag-price-accent.vec', accentBehindMain: true);
  static const AuraIconData target = AuraIconData('assets/vectors/line_duotone/target.vec', accentAssetPath: 'assets/vectors/line_duotone/target-accent.vec');
  static const AuraIconData teaCup = AuraIconData('assets/vectors/line_duotone/tea-cup.vec', accentAssetPath: 'assets/vectors/line_duotone/tea-cup-accent.vec');
  static const AuraIconData telescope = AuraIconData('assets/vectors/line_duotone/telescope.vec', accentAssetPath: 'assets/vectors/line_duotone/telescope-accent.vec');
  static const AuraIconData temperature = AuraIconData('assets/vectors/line_duotone/temperature.vec', accentAssetPath: 'assets/vectors/line_duotone/temperature-accent.vec', accentBehindMain: true);
  static const AuraIconData tennis = AuraIconData('assets/vectors/line_duotone/tennis.vec', accentAssetPath: 'assets/vectors/line_duotone/tennis-accent.vec');
  static const AuraIconData tennis2 = AuraIconData('assets/vectors/line_duotone/tennis-2.vec', accentAssetPath: 'assets/vectors/line_duotone/tennis-2-accent.vec');
  static const AuraIconData testTube = AuraIconData('assets/vectors/line_duotone/test-tube.vec', accentAssetPath: 'assets/vectors/line_duotone/test-tube-accent.vec');
  static const AuraIconData testTubeMinimalistic = AuraIconData('assets/vectors/line_duotone/test-tube-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/test-tube-minimalistic-accent.vec');
  static const AuraIconData textBold = AuraIconData('assets/vectors/line_duotone/text-bold.vec', accentAssetPath: 'assets/vectors/line_duotone/text-bold-accent.vec');
  static const AuraIconData textBoldCircle = AuraIconData('assets/vectors/line_duotone/text-bold-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/text-bold-circle-accent.vec', accentBehindMain: true);
  static const AuraIconData textBoldSquare = AuraIconData('assets/vectors/line_duotone/text-bold-square.vec', accentAssetPath: 'assets/vectors/line_duotone/text-bold-square-accent.vec', accentBehindMain: true);
  static const AuraIconData textCircle = AuraIconData('assets/vectors/line_duotone/text-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/text-circle-accent.vec', accentBehindMain: true);
  static const AuraIconData textCross = AuraIconData('assets/vectors/line_duotone/text-cross.vec', accentAssetPath: 'assets/vectors/line_duotone/text-cross-accent.vec', accentBehindMain: true);
  static const AuraIconData textCrossCircle = AuraIconData('assets/vectors/line_duotone/text-cross-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/text-cross-circle-accent.vec', accentBehindMain: true);
  static const AuraIconData textCrossSquare = AuraIconData('assets/vectors/line_duotone/text-cross-square.vec', accentAssetPath: 'assets/vectors/line_duotone/text-cross-square-accent.vec');
  static const AuraIconData textField = AuraIconData('assets/vectors/line_duotone/text-field.vec', accentAssetPath: 'assets/vectors/line_duotone/text-field-accent.vec', accentBehindMain: true);
  static const AuraIconData textFieldFocus = AuraIconData('assets/vectors/line_duotone/text-field-focus.vec', accentAssetPath: 'assets/vectors/line_duotone/text-field-focus-accent.vec');
  static const AuraIconData textFormat = AuraIconData('assets/vectors/line_duotone/text-format.vec', accentAssetPath: 'assets/vectors/line_duotone/text-format-accent.vec');
  static const AuraIconData textItalic = AuraIconData('assets/vectors/line_duotone/text-italic.vec', accentAssetPath: 'assets/vectors/line_duotone/text-italic-accent.vec');
  static const AuraIconData textItalicCircle = AuraIconData('assets/vectors/line_duotone/text-italic-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/text-italic-circle-accent.vec');
  static const AuraIconData textItalicSquare = AuraIconData('assets/vectors/line_duotone/text-italic-square.vec', accentAssetPath: 'assets/vectors/line_duotone/text-italic-square-accent.vec', accentBehindMain: true);
  static const AuraIconData textSelection = AuraIconData('assets/vectors/line_duotone/text-selection.vec', accentAssetPath: 'assets/vectors/line_duotone/text-selection-accent.vec');
  static const AuraIconData textSquare = AuraIconData('assets/vectors/line_duotone/text-square.vec', accentAssetPath: 'assets/vectors/line_duotone/text-square-accent.vec');
  static const AuraIconData textSquare2 = AuraIconData('assets/vectors/line_duotone/text-square-2.vec', accentAssetPath: 'assets/vectors/line_duotone/text-square-2-accent.vec', accentBehindMain: true);
  static const AuraIconData textUnderline = AuraIconData('assets/vectors/line_duotone/text-underline.vec', accentAssetPath: 'assets/vectors/line_duotone/text-underline-accent.vec');
  static const AuraIconData textUnderlineCircle = AuraIconData('assets/vectors/line_duotone/text-underline-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/text-underline-circle-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData trafficEconomy = AuraIconData('assets/vectors/line_duotone/traffic-economy.vec', accentAssetPath: 'assets/vectors/line_duotone/traffic-economy-accent.vec', accentBehindMain: true);
  static const AuraIconData tram = AuraIconData('assets/vectors/line_duotone/tram.vec', accentAssetPath: 'assets/vectors/line_duotone/tram-accent.vec');
  static const AuraIconData transferHorizontal = AuraIconData('assets/vectors/line_duotone/transfer-horizontal.vec', accentAssetPath: 'assets/vectors/line_duotone/transfer-horizontal-accent.vec');
  static const AuraIconData transferVertical = AuraIconData('assets/vectors/line_duotone/transfer-vertical.vec', accentAssetPath: 'assets/vectors/line_duotone/transfer-vertical-accent.vec');
  static const AuraIconData translation = AuraIconData('assets/vectors/line_duotone/translation.vec', accentAssetPath: 'assets/vectors/line_duotone/translation-accent.vec', accentBehindMain: true);
  static const AuraIconData translation2 = AuraIconData('assets/vectors/line_duotone/translation-2.vec', accentAssetPath: 'assets/vectors/line_duotone/translation-2-accent.vec', accentBehindMain: true);
  static const AuraIconData transmission = AuraIconData('assets/vectors/line_duotone/transmission.vec', accentAssetPath: 'assets/vectors/line_duotone/transmission-accent.vec');
  static const AuraIconData transmissionCircle = AuraIconData('assets/vectors/line_duotone/transmission-circle.vec', accentAssetPath: 'assets/vectors/line_duotone/transmission-circle-accent.vec');
  static const AuraIconData transmissionSquare = AuraIconData('assets/vectors/line_duotone/transmission-square.vec', accentAssetPath: 'assets/vectors/line_duotone/transmission-square-accent.vec');
  static const AuraIconData trashBin2 = AuraIconData('assets/vectors/line_duotone/trash-bin-2.vec', accentAssetPath: 'assets/vectors/line_duotone/trash-bin-2-accent.vec');
  static const AuraIconData trashBinMinimalistic = AuraIconData('assets/vectors/line_duotone/trash-bin-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/trash-bin-minimalistic-accent.vec', accentBehindMain: true);
  static const AuraIconData trashBinMinimalistic2 = AuraIconData('assets/vectors/line_duotone/trash-bin-minimalistic-2.vec', accentAssetPath: 'assets/vectors/line_duotone/trash-bin-minimalistic-2-accent.vec');
  static const AuraIconData trashBinTrash = AuraIconData('assets/vectors/line_duotone/trash-bin-trash.vec', accentAssetPath: 'assets/vectors/line_duotone/trash-bin-trash-accent.vec');
  static const AuraIconData treadmill = AuraIconData('assets/vectors/line_duotone/treadmill.vec', accentAssetPath: 'assets/vectors/line_duotone/treadmill-accent.vec');
  static const AuraIconData treadmillRound = AuraIconData('assets/vectors/line_duotone/treadmill-round.vec', accentAssetPath: 'assets/vectors/line_duotone/treadmill-round-accent.vec');
  static const AuraIconData tuning = AuraIconData('assets/vectors/line_duotone/tuning.vec', accentAssetPath: 'assets/vectors/line_duotone/tuning-accent.vec');
  static const AuraIconData tuning2 = AuraIconData('assets/vectors/line_duotone/tuning-2.vec', accentAssetPath: 'assets/vectors/line_duotone/tuning-2-accent.vec');
  static const AuraIconData tuning3 = AuraIconData('assets/vectors/line_duotone/tuning-3.vec', accentAssetPath: 'assets/vectors/line_duotone/tuning-3-accent.vec');
  static const AuraIconData tuning4 = AuraIconData('assets/vectors/line_duotone/tuning-4.vec', accentAssetPath: 'assets/vectors/line_duotone/tuning-4-accent.vec');
  static const AuraIconData tuningSquare = AuraIconData('assets/vectors/line_duotone/tuning-square.vec', accentAssetPath: 'assets/vectors/line_duotone/tuning-square-accent.vec', accentBehindMain: true);
  static const AuraIconData tuningSquare2 = AuraIconData('assets/vectors/line_duotone/tuning-square-2.vec', accentAssetPath: 'assets/vectors/line_duotone/tuning-square-2-accent.vec', accentBehindMain: true);
  static const AuraIconData turntable = AuraIconData('assets/vectors/line_duotone/turntable.vec', accentAssetPath: 'assets/vectors/line_duotone/turntable-accent.vec');
  static const AuraIconData turntableMinimalistic = AuraIconData('assets/vectors/line_duotone/turntable-minimalistic.vec', accentAssetPath: 'assets/vectors/line_duotone/turntable-minimalistic-accent.vec');
  static const AuraIconData turntableMusicNote = AuraIconData('assets/vectors/line_duotone/turntable-music-note.vec', accentAssetPath: 'assets/vectors/line_duotone/turntable-music-note-accent.vec');
  static const AuraIconData tv = AuraIconData('assets/vectors/line_duotone/tv.vec', accentAssetPath: 'assets/vectors/line_duotone/tv-accent.vec');
  static const AuraIconData ufo = AuraIconData('assets/vectors/line_duotone/ufo.vec', accentAssetPath: 'assets/vectors/line_duotone/ufo-accent.vec', accentBehindMain: true);
  static const AuraIconData ufo2 = AuraIconData('assets/vectors/line_duotone/ufo-2.vec', accentAssetPath: 'assets/vectors/line_duotone/ufo-2-accent.vec');
  static const AuraIconData ufo3 = AuraIconData('assets/vectors/line_duotone/ufo-3.vec', accentAssetPath: 'assets/vectors/line_duotone/ufo-3-accent.vec');
  static const AuraIconData umbrella = AuraIconData('assets/vectors/line_duotone/umbrella.vec', accentAssetPath: 'assets/vectors/line_duotone/umbrella-accent.vec');
  static const AuraIconData undoLeft = AuraIconData('assets/vectors/line_duotone/undo-left.vec', accentAssetPath: 'assets/vectors/line_duotone/undo-left-accent.vec');
  static const AuraIconData undoLeftRound = AuraIconData('assets/vectors/line_duotone/undo-left-round.vec', accentAssetPath: 'assets/vectors/line_duotone/undo-left-round-accent.vec');
  static const AuraIconData undoLeftRoundSquare = AuraIconData('assets/vectors/line_duotone/undo-left-round-square.vec', accentAssetPath: 'assets/vectors/line_duotone/undo-left-round-square-accent.vec');
  static const AuraIconData undoLeftSquare = AuraIconData('assets/vectors/line_duotone/undo-left-square.vec', accentAssetPath: 'assets/vectors/line_duotone/undo-left-square-accent.vec');
  static const AuraIconData undoRight = AuraIconData('assets/vectors/line_duotone/undo-right.vec', accentAssetPath: 'assets/vectors/line_duotone/undo-right-accent.vec');
  static const AuraIconData undoRightRound = AuraIconData('assets/vectors/line_duotone/undo-right-round.vec', accentAssetPath: 'assets/vectors/line_duotone/undo-right-round-accent.vec');
  static const AuraIconData undoRightRoundSquare = AuraIconData('assets/vectors/line_duotone/undo-right-round-square.vec', accentAssetPath: 'assets/vectors/line_duotone/undo-right-round-square-accent.vec', accentBehindMain: true);
  ...
  static const AuraIconData uploadTrack = AuraIconData('assets/vectors/line_duotone/upload-track.vec', accentAssetPath: 'assets/vectors/line_duotone/upload-track-accent.vec');
  static const AuraIconData uploadTrack2 = AuraIconData('assets/vectors/line_duotone/upload-track-2.vec', accentAssetPath: 'assets/vectors/line_duotone/upload-track-2-accent.vec');
  static const AuraIconData uploadTwiceSquare = AuraIconData('assets/vectors/line_duotone/upload-twice-square.vec', accentAssetPath: 'assets/vectors/line_duotone/upload-twice-square-accent.vec');
  static const AuraIconData usb = AuraIconData('assets/vectors/line_duotone/usb.vec', accentAssetPath: 'assets/vectors/line_duotone/usb-accent.vec');
  ...
  static const AuraIconData usersGroupRounded = AuraIconData('assets/vectors/line_duotone/users-group-rounded.vec', accentAssetPath: 'assets/vectors/line_duotone/users-group-rounded-accent.vec');
  static const AuraIconData usersGroupTwoRounded = AuraIconData('assets/vectors/line_duotone/users-group-two-rounded.vec', accentAssetPath: 'assets/vectors/line_duotone/users-group-two-rounded-accent.vec');
  static const AuraIconData vanity = AuraIconData('assets/vectors/line_duotone/vanity.vec', accentAssetPath: 'assets/vectors/line_duotone/vanity-accent.vec', accentBehindMain: true);
  static const AuraIconData verifiedCheck = AuraIconData('assets/vectors/line_duotone/verified-check.vec', accentAssetPath: 'assets/vectors/line_duotone/verified-check-accent.vec', accentBehindMain: true);
  static const AuraIconData videoFrame = AuraIconData('assets/vectors/line_duotone/video-frame.vec', accentAssetPath: 'assets/vectors/line_duotone/video-frame-accent.vec');
  static const AuraIconData videoFrame2 = AuraIconData('assets/vectors/line_duotone/video-frame-2.vec', accentAssetPath: 'assets/vectors/line_duotone/video-frame-2-accent.vec');
  static const AuraIconData videoFrameCut = AuraIconData('assets/vectors/line_duotone/video-frame-cut.vec', accentAssetPath: 'assets/vectors/line_duotone/video-frame-cut-accent.vec');
  static const AuraIconData videoFrameCut2 = AuraIconData('assets/vectors/line_duotone/video-frame-cut-2.vec', accentAssetPath: 'assets/vectors/line_duotone/video-frame-cut-2-accent.vec');
  static const AuraIconData videoFramePlayHorizontal = AuraIconData('assets/vectors/line_duotone/video-frame-play-horizontal.vec', accentAssetPath: 'assets/vectors/line_duotone/video-frame-play-horizontal-accent.vec');
  static const AuraIconData videoFramePlayVertical = AuraIconData('assets/vectors/line_duotone/video-frame-play-vertical.vec', accentAssetPath: 'assets/vectors/line_duotone/video-frame-play-vertical-accent.vec');
  static const AuraIconData videoFrameReplace = AuraIconData('assets/vectors/line_duotone/video-frame-replace.vec', accentAssetPath: 'assets/vectors/line_duotone/video-frame-replace-accent.vec');
  ...
  static const AuraIconData volumeSmall = AuraIconData('assets/vectors/line_duotone/volume-small.vec', accentAssetPath: 'assets/vectors/line_duotone/volume-small-accent.vec');
  static const AuraIconData walking = AuraIconData('assets/vectors/line_duotone/walking.vec', accentAssetPath: 'assets/vectors/line_duotone/walking-accent.vec', accentBehindMain: true);
  static const AuraIconData walkingRound = AuraIconData('assets/vectors/line_duotone/walking-round.vec', accentAssetPath: 'assets/vectors/line_duotone/walking-round-accent.vec', accentBehindMain: true);
  static const AuraIconData wallet = AuraIconData('assets/vectors/line_duotone/wallet.vec', accentAssetPath: 'assets/vectors/line_duotone/wallet-accent.vec');
  static const AuraIconData wallet2 = AuraIconData('assets/vectors/line_duotone/wallet-2.vec', accentAssetPath: 'assets/vectors/line_duotone/wallet-2-accent.vec');
  static const AuraIconData walletMoney = AuraIconData('assets/vectors/line_duotone/wallet-money.vec', accentAssetPath: 'assets/vectors/line_duotone/wallet-money-accent.vec', accentBehindMain: true);
  static const AuraIconData wallpaper = AuraIconData('assets/vectors/line_duotone/wallpaper.vec', accentAssetPath: 'assets/vectors/line_duotone/wallpaper-accent.vec');
  ...
  static const AuraIconData widget = AuraIconData('assets/vectors/line_duotone/widget.vec', accentAssetPath: 'assets/vectors/line_duotone/widget-accent.vec', accentBehindMain: true);
  static const AuraIconData widget2 = AuraIconData('assets/vectors/line_duotone/widget-2.vec', accentAssetPath: 'assets/vectors/line_duotone/widget-2-accent.vec');
  static const AuraIconData widget3 = AuraIconData('assets/vectors/line_duotone/widget-3.vec', accentAssetPath: 'assets/vectors/line_duotone/widget-3-accent.vec', accentBehindMain: true);
  static const AuraIconData widget4 = AuraIconData('assets/vectors/line_duotone/widget-4.vec', accentAssetPath: 'assets/vectors/line_duotone/widget-4-accent.vec', accentBehindMain: true);
  static const AuraIconData widget5 = AuraIconData('assets/vectors/line_duotone/widget-5.vec', accentAssetPath: 'assets/vectors/line_duotone/widget-5-accent.vec', accentBehindMain: true);
  static const AuraIconData widget6 = AuraIconData('assets/vectors/line_duotone/widget-6.vec', accentAssetPath: 'assets/vectors/line_duotone/widget-6-accent.vec', accentBehindMain: true);
  static const AuraIconData widgetAdd = AuraIconData('assets/vectors/line_duotone/widget-add.vec', accentAssetPath: 'assets/vectors/line_duotone/widget-add-accent.vec');
  static const AuraIconData winRar = AuraIconData('assets/vectors/line_duotone/win-rar.vec', accentAssetPath: 'assets/vectors/line_duotone/win-rar-accent.vec');
  static const AuraIconData wind = AuraIconData('assets/vectors/line_duotone/wind.vec', accentAssetPath: 'assets/vectors/line_duotone/wind-accent.vec');
  static const AuraIconData windowFrame = AuraIconData('assets/vectors/line_duotone/window-frame.vec', accentAssetPath: 'assets/vectors/line_duotone/window-frame-accent.vec');
  static const AuraIconData wineglass = AuraIconData('assets/vectors/line_duotone/wineglass.vec', accentAssetPath: 'assets/vectors/line_duotone/wineglass-accent.vec');
  static const AuraIconData wineglassTriangle = AuraIconData('assets/vectors/line_duotone/wineglass-triangle.vec', accentAssetPath: 'assets/vectors/line_duotone/wineglass-triangle-accent.vec');
